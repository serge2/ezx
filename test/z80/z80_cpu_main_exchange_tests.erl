...
ex_af_af_test() ->
    ...
    Mem1 = ezx_memory_48:cpu_write_byte(Mem0, 0, 16#08),  %% EX AF,AF'
...
ex_af_af_twice_test() ->
    ...
    Mem0 = Machine0#machine_state.memory,
    Mem1 = ezx_memory_48:cpu_write_byte(Mem0, 0, 16#08),  %% EX AF,AF'
    Mem2 = ezx_memory_48:cpu_write_byte(Mem1, 1, 16#08),  %% EX AF,AF'
...
ex_de_hl_test() ->
    ...
    Mem0 = Machine0#machine_state.memory,
    Mem1 = ezx_memory_48:cpu_write_byte(Mem0, 0, 16#EB),  %% EX DE,HL
    Machine1 = Machine0#machine_state{cpu = Cpu0, memory = Mem1},
    Machine2 = z80_cpu:step(Machine1),
...
ex_sp_hl_test() ->
    ...
    Mem0 = Machine0#machine_state.memory,
    Mem1 = ezx_memory_48:cpu_write_byte(Mem0, 16#FEFE, 16#78),  %% Low byte at SP
    Mem2 = ezx_memory_48:cpu_write_byte(Mem1, 16#FEFF, 16#56),  %% High byte at SP+1
    Mem3 = ezx_memory_48:cpu_write_byte(Mem2, 0, 16#E3),  %% EX (SP),HL
    ...
    ?assertEqual(16#34, ezx_emulator:read_byte(Machine2, 16#FEFE)),  %% Low byte = old L
    ?assertEqual(16#12, ezx_emulator:read_byte(Machine2, 16#FEFF)),  %% High byte = old H
...
exx_test() ->
    ...
    Mem0 = Machine0#machine_state.memory,
    Mem1 = ezx_memory_48:cpu_write_byte(Mem0, 0, 16#D9),  %% EXX
    Machine1 = Machine0#machine_state{cpu = Cpu0, memory = Mem1},
    Machine2 = z80_cpu:step(Machine1),
...
exx_twice_test() ->
    ...
    Mem0 = Machine0#machine_state.memory,
    Mem1 = ezx_memory_48:cpu_write_byte(Mem0, 0, 16#D9),  %% EXX
    Mem2 = ezx_memory_48:cpu_write_byte(Mem1, 1, 16#D9),  %% EXX
    Machine1 = Machine0#machine_state{cpu = Cpu0, memory = Mem2},
    Machine2 = z80_cpu:step(Machine1),
    Machine3 = z80_cpu:step(Machine2),
...
pop_bc_test() ->
    Machine0 = ezx_emulator:init(),
    Mem0 = Machine0#machine_state.memory,
    Mem1 = ezx_memory_48:cpu_write_byte(Mem0, 16#FEFE, 16#56),
    Mem2 = ezx_memory_48:cpu_write_byte(Mem1, 16#FEFF, 16#78),
