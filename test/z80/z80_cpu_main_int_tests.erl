...
di_test() ->
    ...
    Mem1 = ezx_mem:write_byte(Mem0, 0, 16#F3),  %% DI
...
ei_test() ->
    ...
    Mem0 = Machine0#machine_state.memory,
    Mem1 = ezx_mem:write_byte(Mem0, 0, 16#FB),  %% EI
    Machine1 = Machine0#machine_state{cpu = Cpu0, memory = Mem1},
    Machine2 = z80_cpu:step(Machine1),
...
ei_blocks_interrupt_until_next_instruction_test() ->
    ...
    Cpu0 = Machine0#machine_state.cpu#cpu_state{iff1 = 0, iff2 = 0, pc = 16#1000},
    Mem0 = Machine0#machine_state.memory,
    Mem1 = ezx_mem:write_byte(Mem0, 16#1000, 16#FB),  %% EI
    Mem2 = ezx_mem:write_byte(Mem1, 16#1001, 16#00),  %% NOP
...
di_ei_timing_test() ->
    ...
    Mem0 = Machine0#machine_state.memory,
    Mem1 = ezx_mem:write_byte(Mem0, 0, 16#F3),  %% DI
    Mem2 = ezx_mem:write_byte(Mem1, 1, 16#FB),  %% EI
...
r_register_prefix_ed_increments_twice_test() ->
    Machine0 = ezx_emulator:init(),
    Mem0 = Machine0#machine_state.memory,
    Mem1 = ezx_mem:write_byte(Mem0, 0, 16#ED),
    Mem2 = ezx_mem:write_byte(Mem1, 1, 16#47),  %% LD I,A
    Machine1 = Machine0#machine_state{memory = Mem2},
...
r_register_dd_fd_prefix_increments_once_test() ->
    Machine0 = ezx_emulator:init(),
    Mem0 = Machine0#machine_state.memory,
    Mem1 = ezx_mem:write_byte(Mem0, 0, 16#DD),
    Mem2 = ezx_mem:write_byte(Mem1, 1, 16#21),  %% LD IX,nn
    Mem3 = ezx_mem:write_byte(Mem2, 2, 16#00),
    Mem4 = ezx_mem:write_byte(Mem3, 3, 16#40),
...
flag_s_test() ->
    ...
    Mem0 = Machine0#machine_state.memory,
    Mem1 = ezx_mem:write_byte(Mem0, 0, 16#3C),  %% INC A (16#80 -> 16#81)
    Machine1 = Machine0#machine_state{cpu = Cpu0, memory = Mem1},
    Machine2 = z80_cpu:step(Machine1),
...
flag_z_test() ->
    ...
    Mem0 = Machine0#machine_state.memory,
    Mem1 = ezx_mem:write_byte(Mem0, 0, 16#3C),  %% INC A (16#FF -> 16#00)
    Machine1 = Machine0#machine_state{cpu = Cpu0, memory = Mem1},
    Machine2 = z80_cpu:step(Machine1),
...
flag_h_add_test() ->
    ...
    Mem2 = ezx_mem:write_byte(Mem1, 1, 16#01),
    Machine1 = Machine0#machine_state{cpu = Cpu0, memory = Mem2},
    Machine2 = z80_cpu:step(Machine1),
...
flag_pv_overflow_add_test() ->
    ...
    Mem0 = Machine0#machine_state.memory,
    Mem1 = ezx_mem:write_byte(Mem0, 0, 16#C6),  %% ADD A,n
    Mem2 = ezx_mem:write_byte(Mem1, 1, 16#01),  %% 7F + 01 = 80 -> overflow
    Machine1 = Machine0#machine_state{cpu = Cpu0, memory = Mem2},
    Machine2 = z80_cpu:step(Machine1),
...
flag_pv_overflow_sub_test() ->
    ...
    Mem0 = Machine0#machine_state.memory,
    Mem1 = ezx_mem:write_byte(Mem0, 0, 16#D6),  %% SUB n
    Mem2 = ezx_mem:write_byte(Mem1, 1, 16#01),  %% 80 - 01 = 7F -> overflow
    Machine1 = Machine0#machine_state{cpu = Cpu0, memory = Mem2},
    Machine2 = z80_cpu:step(Machine1),
    ?assertEqual(?FLAG_V, Machine2#machine_state.cpu#cpu_state.f band ?FLAG_V).
