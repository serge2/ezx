...
ed_rrd_test() ->
    ...
    Machine1 = ezx_emulator:write_byte(Machine0, 0, 16#ED),
    Machine2 = ezx_emulator:write_byte(Machine1, 1, 16#67),
    Machine3 = ezx_emulator:write_byte(Machine2, 16#4000, 16#34),
    ...
    ?assertEqual(16#03, ezx_emulator:read_byte(Machine5, 16#4000)),
    ?assertEqual(18, z80_cpu:t_states(Machine5)).

ed_rld_test() ->
    Machine0 = ezx_emulator:init(),
    Machine1 = ezx_emulator:write_byte(Machine0, 0, 16#ED),
    Machine2 = ezx_emulator:write_byte(Machine1, 1, 16#6F),
    Machine3 = ezx_emulator:write_byte(Machine2, 16#4000, 16#34),
    Cpu1 = Machine3#machine_state.cpu#cpu_state{a = 16#00, h = 16#40, l = 16#00},
    Machine4 = Machine3#machine_state{cpu = Cpu1},
    Machine5 = z80_cpu:step(Machine4),
    ?assertEqual(16#03, Machine5#machine_state.cpu#cpu_state.a),
    ?assertEqual(16#40, ezx_emulator:read_byte(Machine5, 16#4000)),
    ?assertEqual(18, z80_cpu:t_states(Machine5)).
...
ed_ld_i_a_test() ->
    Machine0 = ezx_emulator:init(),
    Machine1 = ezx_emulator:write_byte(Machine0, 0, 16#ED), %% LD I,A
    Machine2 = ezx_emulator:write_byte(Machine1, 1, 16#47),
...
ed_ld_a_i_test() ->
    Machine0 = ezx_emulator:init(),
    Machine1 = ezx_emulator:write_byte(Machine0, 0, 16#ED), %% LD A,I
    Machine2 = ezx_emulator:write_byte(Machine1, 1, 16#57),
...
ed_ld_r_a_test() ->
    Machine0 = ezx_emulator:init(),
    Machine1 = ezx_emulator:write_byte(Machine0, 0, 16#ED), %% LD R,A
    Machine2 = ezx_emulator:write_byte(Machine1, 1, 16#4F),
...
ed_ld_a_r_test() ->
    Machine0 = ezx_emulator:init(),
    Machine1 = ezx_emulator:write_byte(Machine0, 0, 16#ED), %% LD A,R
    Machine2 = ezx_emulator:write_byte(Machine1, 1, 16#5F),
...
ed_neg_test() ->
    Machine0 = ezx_emulator:init(),
    Machine1 = ezx_emulator:write_byte(Machine0, 0, 16#ED),
    Machine2 = ezx_emulator:write_byte(Machine1, 1, 16#44),
...
ed_adc_hl_bc_test() ->
    Machine0 = ezx_emulator:init(),
    Machine1 = ezx_emulator:write_byte(Machine0, 0, 16#ED),
    Machine2 = ezx_emulator:write_byte(Machine1, 1, 16#4A),
...
ed_sbc_hl_bc_test() ->
    Machine0 = ezx_emulator:init(),
    Machine1 = ezx_emulator:write_byte(Machine0, 0, 16#ED),
    Machine2 = ezx_emulator:write_byte(Machine1, 1, 16#42),
    Cpu1 = Machine2#machine_state.cpu#cpu_state{h = 16#12, l = 16#34, b = 16#00, c = 16#78, f = 0},
    Machine3 = Machine2#machine_state{cpu = Cpu1},
    Machine4 = z80_cpu:step(Machine3),
...
ed_adc_hl_de_test() ->
    Machine0 = ezx_emulator:init(),
    Machine1 = ezx_emulator:write_byte(Machine0, 0, 16#ED),
    Machine2 = ezx_emulator:write_byte(Machine1, 1, 16#5A),
...
ed_sbc_hl_de_test() ->
    Machine0 = ezx_emulator:init(),
    Machine1 = ezx_emulator:write_byte(Machine0, 0, 16#ED),
    Machine2 = ezx_emulator:write_byte(Machine1, 1, 16#52),
...
ed_adc_hl_hl_test() ->
    Machine0 = ezx_emulator:init(),
    Machine1 = ezx_emulator:write_byte(Machine0, 0, 16#ED),
    Machine2 = ezx_emulator:write_byte(Machine1, 1, 16#6A),
...
ed_sbc_hl_hl_test() ->
    Machine0 = ezx_emulator:init(),
    Machine1 = ezx_emulator:write_byte(Machine0, 0, 16#ED),
    Machine2 = ezx_emulator:write_byte(Machine1, 1, 16#62),
    Cpu1 = Machine2#machine_state.cpu#cpu_state{h = 16#12, l = 16#34, f = 0},
    Machine3 = Machine2#machine_state{cpu = Cpu1},
    Machine4 = z80_cpu:step(Machine3),
...
ed_adc_hl_sp_test() ->
    Machine0 = ezx_emulator:init(),
    Machine1 = ezx_emulator:write_byte(Machine0, 0, 16#ED),
    Machine2 = ezx_emulator:write_byte(Machine1, 1, 16#7A),
...
ed_sbc_hl_sp_test() ->
    Machine0 = ezx_emulator:init(),
    Machine1 = ezx_emulator:write_byte(Machine0, 0, 16#ED),
    Machine2 = ezx_emulator:write_byte(Machine1, 1, 16#72),
...
ed_in_b_c_test() ->
    Machine0 = ezx_emulator:init(),
    Machine1 = ezx_emulator:write_byte(Machine0, 0, 16#ED),
    Machine2 = ezx_emulator:write_byte(Machine1, 1, 16#40),
...
ed_in_a_c_test() ->
    Machine0 = ezx_emulator:init(),
    Machine1 = ezx_emulator:write_byte(Machine0, 0, 16#ED),
    Machine2 = ezx_emulator:write_byte(Machine1, 1, 16#78),
...
ed_in_f_c_test() ->
    Machine0 = ezx_emulator:init(),
    Machine1 = ezx_emulator:write_byte(Machine0, 0, 16#ED),
    Machine2 = ezx_emulator:write_byte(Machine1, 1, 16#70),
...
ed_out_c_b_test() ->
    Machine0 = ezx_emulator:init(),
    Machine1 = ezx_emulator:write_byte(Machine0, 0, 16#ED),
    Machine2 = ezx_emulator:write_byte(Machine1, 1, 16#41),
...
ed_out_c_a_test() ->
    Machine0 = ezx_emulator:init(),
    Machine1 = ezx_emulator:write_byte(Machine0, 0, 16#ED),
    Machine2 = ezx_emulator:write_byte(Machine1, 1, 16#79),
...
ed_out_c_0_test() ->
    Machine0 = ezx_emulator:init(),
    Machine1 = ezx_emulator:write_byte(Machine0, 0, 16#ED),
    Machine2 = ezx_emulator:write_byte(Machine1, 1, 16#71),
...
ed_ldi_test() ->
    Machine0 = ezx_emulator:init(),
    Machine1 = ezx_emulator:write_byte(Machine0, 0, 16#ED),
    Machine2 = ezx_emulator:write_byte(Machine1, 1, 16#A0),
...
ed_ldd_test() ->
    Machine0 = ezx_emulator:init(),
    Machine1 = ezx_emulator:write_byte(Machine0, 0, 16#ED),
    Machine2 = ezx_emulator:write_byte(Machine1, 1, 16#A8),
    Cpu1 = Machine2#machine_state.cpu#cpu_state{h = 16#40, l = 16#00, d = 16#50, e = 16#00, b = 0, c = 16#02, a = 16#00},
    Machine3 = Machine2#machine_state{cpu = Cpu1},
    Machine4 = z80_cpu:step(Machine3),
...
ed_ldir_test() ->
    Machine0 = ezx_emulator:init(),
    Machine1 = ezx_emulator:write_byte(Machine0, 0, 16#ED),
    Machine2 = ezx_emulator:write_byte(Machine1, 1, 16#B0),
    Machine3 = ezx_emulator:write_byte(Machine2, 16#4000, 16#11),
    Machine4 = ezx_emulator:write_byte(Machine3, 16#4001, 16#22),
    ...
    ?assertEqual(16#11, ezx_emulator:read_byte(Machine6, 16#5000)),
    ?assertEqual(21, z80_cpu:t_states(Machine6)).

ed_lddr_test() ->
    Machine0 = ezx_emulator:init(),
    Machine1 = ezx_emulator:write_byte(Machine0, 0, 16#ED),
    Machine2 = ezx_emulator:write_byte(Machine1, 1, 16#B8),
    Machine3 = ezx_emulator:write_byte(Machine2, 16#4000, 16#11),
    Machine4 = ezx_emulator:write_byte(Machine3, 16#4001, 16#22),
    ...
    ?assertEqual(16#0001, z80_cpu_helpers:get_reg_pair(bc, Machine6#machine_state.cpu)),
    ?assertEqual(16#22, ezx_emulator:read_byte(Machine6, 16#5001)),
    ?assertEqual(21, z80_cpu:t_states(Machine6)).
...
ed_cpi_test() ->
    Machine0 = ezx_emulator:init(),
    Machine1 = ezx_emulator:write_byte(Machine0, 0, 16#ED),
    Machine2 = ezx_emulator:write_byte(Machine1, 1, 16#A1),
    Cpu1 = Machine2#machine_state.cpu#cpu_state{h = 16#40, l = 16#00, a = 16#55, b = 0, c = 16#03},
    Machine3 = ezx_emulator:write_byte(Machine2, 16#4000, 16#55),
    Machine4 = Machine3#machine_state{cpu = Cpu1},
    Machine5 = z80_cpu:step(Machine4),
...
ed_cpi_no_match_test() ->
    ...
    Machine2 = ezx_emulator:write_byte(Machine1, 1, 16#A1),
    Cpu1 = Machine2#machine_state.cpu#cpu_state{h = 16#40, l = 16#00, a = 16#55, b = 0, c = 16#03},
    Machine3 = ezx_emulator:write_byte(Machine2, 16#4000, 16#44),
    Machine4 = Machine3#machine_state{cpu = Cpu1},
    Machine5 = z80_cpu:step(Machine4),
    ?assertEqual(16#4001, z80_cpu_helpers:get_reg_pair(hl, Machine5#machine_state.cpu)),
    ?assertEqual(16#0002, z80_cpu_helpers:get_reg_pair(bc, Machine5#machine_state.cpu)),
...
ed_cpir_test() ->
    Machine0 = ezx_emulator:init(),
    Machine1 = ezx_emulator:write_byte(Machine0, 0, 16#ED),
    Machine2 = ezx_emulator:write_byte(Machine1, 1, 16#B1),
    Machine3 = ezx_emulator:write_byte(Machine2, 16#4000, 16#11),
    Machine4 = ezx_emulator:write_byte(Machine3, 16#4001, 16#55),
    Machine5 = ezx_emulator:write_byte(Machine4, 16#4002, 16#22),
...
ed_cpdr_test() ->
    Machine0 = ezx_emulator:init(),
    Machine1 = ezx_emulator:write_byte(Machine0, 0, 16#ED),
    Machine2 = ezx_emulator:write_byte(Machine1, 1, 16#B9),
    Machine3 = ezx_emulator:write_byte(Machine2, 16#4001, 16#11),
    Machine4 = ezx_emulator:write_byte(Machine3, 16#4000, 16#55),
...
ed_ini_test() ->
    Machine0 = ezx_emulator:init(),
    Machine1 = ezx_emulator:write_byte(Machine0, 0, 16#ED),
    Machine2 = ezx_emulator:write_byte(Machine1, 1, 16#A2),
    Cpu1 = Machine2#machine_state.cpu#cpu_state{b = 0, c = 16#10, h = 16#40, l = 16#00},
    Machine3 = Machine2#machine_state{cpu = Cpu1},
    Machine4 = z80_cpu:step(Machine3),
    ?assertEqual(16#FF, ezx_emulator:read_byte(Machine4, 16#4000)),
    ?assertEqual(16#4001, z80_cpu_helpers:get_reg_pair(hl, Machine4#machine_state.cpu)),
    ?assertEqual(16#FF, Machine4#machine_state.cpu#cpu_state.b),
    ?assertEqual(16, z80_cpu:t_states(Machine4)).
...
ed_ind_test() ->
    Machine0 = ezx_emulator:init(),
    Machine1 = ezx_emulator:write_byte(Machine0, 0, 16#ED),
    Machine2 = ezx_emulator:write_byte(Machine1, 1, 16#AA),
    Cpu1 = Machine2#machine_state.cpu#cpu_state{b = 0, c = 16#10, h = 16#40, l = 16#01},
    Machine3 = Machine2#machine_state{cpu = Cpu1},
    Machine4 = z80_cpu:step(Machine3),
    ?assertEqual(16#FF, ezx_emulator:read_byte(Machine4, 16#4001)),
...
ed_inir_test() ->
    Machine0 = ezx_emulator:init(),
    Machine1 = ezx_emulator:write_byte(Machine0, 0, 16#ED),
    Machine2 = ezx_emulator:write_byte(Machine1, 1, 16#B2),
...
ed_outi_test() ->
    Machine0 = ezx_emulator:init(),
    Machine1 = ezx_emulator:write_byte(Machine0, 0, 16#ED),
    Machine2 = ezx_emulator:write_byte(Machine1, 1, 16#A3),
    Machine3 = ezx_emulator:write_byte(Machine2, 16#4000, 16#55),
...
ed_otir_test() ->
    Machine0 = ezx_emulator:init(),
    Machine1 = ezx_emulator:write_byte(Machine0, 0, 16#ED),
    Machine2 = ezx_emulator:write_byte(Machine1, 1, 16#B3),
    Machine3 = ezx_emulator:write_byte(Machine2, 16#4000, 16#11),
    Machine4 = ezx_emulator:write_byte(Machine3, 16#4001, 16#22),
