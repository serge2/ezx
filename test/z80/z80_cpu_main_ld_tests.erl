...
ld_bc_nn_test() ->
    ...
    Mem1 = ezx_memory_48:cpu_write_byte(Mem0, 0, 16#01),
    Mem2 = ezx_memory_48:cpu_write_byte(Mem1, 1, 16#34),
    Mem3 = ezx_memory_48:cpu_write_byte(Mem2, 2, 16#12),
...
ld_de_nn_test() ->
    Machine0 = ezx_emulator:init(),
    Mem0 = Machine0#machine_state.memory,
    Mem1 = ezx_memory_48:cpu_write_byte(Mem0, 0, 16#11),
    Mem2 = ezx_memory_48:cpu_write_byte(Mem1, 1, 16#56),
    Mem3 = ezx_memory_48:cpu_write_byte(Mem2, 2, 16#78),
    Machine1 = Machine0#machine_state{memory = Mem3},
    Machine2 = z80_cpu:step(Machine1),
...
ld_hl_nn_test() ->
    Machine0 = ezx_emulator:init(),
    Mem0 = Machine0#machine_state.memory,
    Mem1 = ezx_memory_48:cpu_write_byte(Mem0, 0, 16#21),
    Mem2 = ezx_memory_48:cpu_write_byte(Mem1, 1, 16#34),
    Mem3 = ezx_memory_48:cpu_write_byte(Mem2, 2, 16#12),
    Machine1 = Machine0#machine_state{memory = Mem3},
    Machine2 = z80_cpu:step(Machine1),
...
ld_sp_nn_test() ->
    Machine0 = ezx_emulator:init(),
    Mem0 = Machine0#machine_state.memory,
    Mem1 = ezx_memory_48:cpu_write_byte(Mem0, 0, 16#31),
    Mem2 = ezx_memory_48:cpu_write_byte(Mem1, 1, 16#00),
    Mem3 = ezx_memory_48:cpu_write_byte(Mem2, 2, 16#80),
    Machine1 = Machine0#machine_state{memory = Mem3},
    Machine2 = z80_cpu:step(Machine1),
...
ld_b_c_test() ->
    ...
    Mem1 = ezx_memory_48:cpu_write_byte(Mem0, 0, 16#41),  %% LD B,C
...
ld_a_b_test() ->
    ...
    Machine1 = Machine0#machine_state{cpu = Cpu0},
    Mem0 = Machine1#machine_state.memory,
    Mem1 = ezx_memory_48:cpu_write_byte(Mem0, 0, 16#78),  %% LD A,B
    Machine2 = Machine1#machine_state{memory = Mem1},
    Machine3 = z80_cpu:step(Machine2),
...
ld_a_a_test() ->
    ...
    Machine1 = Machine0#machine_state{cpu = Cpu0},
    Mem0 = Machine1#machine_state.memory,
    Mem1 = ezx_memory_48:cpu_write_byte(Mem0, 0, 16#7F),  %% LD A,A
    Machine2 = Machine1#machine_state{memory = Mem1},
    Machine3 = z80_cpu:step(Machine2),
...
ld_b_n_test() ->
    Machine0 = ezx_emulator:init(),
    Mem0 = Machine0#machine_state.memory,
    Mem1 = ezx_memory_48:cpu_write_byte(Mem0, 0, 16#06),  %% LD B,n
    Mem2 = ezx_memory_48:cpu_write_byte(Mem1, 1, 16#42),
...
ld_a_n_test() ->
    Machine0 = ezx_emulator:init(),
    Mem0 = Machine0#machine_state.memory,
    Mem1 = ezx_memory_48:cpu_write_byte(Mem0, 0, 16#3E),  %% LD A,n
    Mem2 = ezx_memory_48:cpu_write_byte(Mem1, 1, 16#77),
    Machine1 = Machine0#machine_state{memory = Mem2},
    Machine2 = z80_cpu:step(Machine1),
...
ld_b_mem_hl_test() ->
    ...
    Mem2 = ezx_memory_48:cpu_write_byte(Mem1, 0, 16#46),  %% LD B,(HL)
...
ld_c_mem_hl_test() ->
    Machine0 = ezx_emulator:init(),
    Mem0 = Machine0#machine_state.memory,
    Mem1 = ezx_memory_48:cpu_write_byte(Mem0, 16#4000, 16#AA),
    Cpu0 = Machine0#machine_state.cpu#cpu_state{h = 16#40, l = 16#00},
    Machine1 = Machine0#machine_state{cpu = Cpu0, memory = Mem1},
    Mem2 = ezx_memory_48:cpu_write_byte(Mem1, 0, 16#4E),  %% LD C,(HL)
    Machine2 = Machine1#machine_state{memory = Mem2},
    Machine3 = z80_cpu:step(Machine2),
...
ld_h_mem_hl_test() ->
    Machine0 = ezx_emulator:init(),
    Mem0 = Machine0#machine_state.memory,
    Mem1 = ezx_memory_48:cpu_write_byte(Mem0, 16#4000, 16#CC),
    Cpu0 = Machine0#machine_state.cpu#cpu_state{h = 16#40, l = 16#00},
    Machine1 = Machine0#machine_state{cpu = Cpu0, memory = Mem1},
    Mem2 = ezx_memory_48:cpu_write_byte(Mem1, 0, 16#66),  %% LD H,(HL)
    Machine2 = Machine1#machine_state{memory = Mem2},
    Machine3 = z80_cpu:step(Machine2),
...
ld_l_mem_hl_test() ->
    Machine0 = ezx_emulator:init(),
    Mem0 = Machine0#machine_state.memory,
    Mem1 = ezx_memory_48:cpu_write_byte(Mem0, 16#4000, 16#DD),
    Cpu0 = Machine0#machine_state.cpu#cpu_state{h = 16#40, l = 16#00},
    Machine1 = Machine0#machine_state{cpu = Cpu0, memory = Mem1},
    Mem2 = ezx_memory_48:cpu_write_byte(Mem1, 0, 16#6E),  %% LD L,(HL)
    Machine2 = Machine1#machine_state{memory = Mem2},
    Machine3 = z80_cpu:step(Machine2),
...
ld_a_mem_hl_test() ->
    Machine0 = ezx_emulator:init(),
    Mem0 = Machine0#machine_state.memory,
    Mem1 = ezx_memory_48:cpu_write_byte(Mem0, 16#4000, 16#EE),
    Cpu0 = Machine0#machine_state.cpu#cpu_state{h = 16#40, l = 16#00},
    Machine1 = Machine0#machine_state{cpu = Cpu0, memory = Mem1},
    Mem2 = ezx_memory_48:cpu_write_byte(Mem1, 0, 16#7E),  %% LD A,(HL)
    Machine2 = Machine1#machine_state{memory = Mem2},
    Machine3 = z80_cpu:step(Machine2),
...
ld_mem_hl_b_test() ->
    ...
    Mem0 = Machine0#machine_state.memory,
    Mem1 = ezx_memory_48:cpu_write_byte(Mem0, 0, 16#70),  %% LD (HL),B
    Machine1 = Machine0#machine_state{cpu = Cpu0, memory = Mem1},
    Machine2 = z80_cpu:step(Machine1),
    ?assertEqual(16#55, ezx_emulator:read_byte(Machine2, 16#4000)),
...
ld_mem_hl_a_test() ->
    ...
    Mem0 = Machine0#machine_state.memory,
    Mem1 = ezx_memory_48:cpu_write_byte(Mem0, 0, 16#77),  %% LD (HL),A
    Machine1 = Machine0#machine_state{cpu = Cpu0, memory = Mem1},
    Machine2 = z80_cpu:step(Machine1),
    ?assertEqual(16#AA, ezx_emulator:read_byte(Machine2, 16#4000)).
...
ld_mem_hl_n_test() ->
    ...
    Cpu0 = Machine0#machine_state.cpu#cpu_state{h = 16#40, l = 16#00},
    Mem0 = Machine0#machine_state.memory,
    Mem1 = ezx_memory_48:cpu_write_byte(Mem0, 0, 16#36),  %% LD (HL),n
    Mem2 = ezx_memory_48:cpu_write_byte(Mem1, 1, 16#77),
    Machine1 = Machine0#machine_state{cpu = Cpu0, memory = Mem2},
    Machine2 = z80_cpu:step(Machine1),
    ?assertEqual(16#77, ezx_emulator:read_byte(Machine2, 16#4000)),
    ?assertEqual(2, z80_cpu:pc(Machine2)).
...
ld_mem_bc_a_test() ->
    ...
    Mem0 = Machine0#machine_state.memory,
    Mem1 = ezx_memory_48:cpu_write_byte(Mem0, 0, 16#02),  %% LD (BC),A
    Machine1 = Machine0#machine_state{cpu = Cpu0, memory = Mem1},
    Machine2 = z80_cpu:step(Machine1),
    ?assertEqual(16#55, ezx_emulator:read_byte(Machine2, 16#4000)),
    ?assertEqual(1, z80_cpu:pc(Machine2)).
...
ld_mem_de_a_test() ->
    ...
    Mem0 = Machine0#machine_state.memory,
    Mem1 = ezx_memory_48:cpu_write_byte(Mem0, 0, 16#12),  %% LD (DE),A
    Machine1 = Machine0#machine_state{cpu = Cpu0, memory = Mem1},
    Machine2 = z80_cpu:step(Machine1),
    ?assertEqual(16#AA, ezx_emulator:read_byte(Machine2, 16#4000)).
...
ld_a_mem_bc_test() ->
    ...
    Machine1 = Machine0#machine_state{cpu = Cpu0, memory = Mem1},
    Mem2 = ezx_memory_48:cpu_write_byte(Mem1, 0, 16#0A),  %% LD A,(BC)
    Machine2 = Machine1#machine_state{memory = Mem2},
    Machine3 = z80_cpu:step(Machine2),
    ?assertEqual(16#55, Machine3#machine_state.cpu#cpu_state.a),
    ?assertEqual(1, z80_cpu:pc(Machine3)).
...
ld_a_mem_de_test() ->
    ...
    Machine1 = Machine0#machine_state{cpu = Cpu0, memory = Mem1},
    Mem2 = ezx_memory_48:cpu_write_byte(Mem1, 0, 16#1A),  %% LD A,(DE)
    Machine2 = Machine1#machine_state{memory = Mem2},
    Machine3 = z80_cpu:step(Machine2),
    ?assertEqual(16#AA, Machine3#machine_state.cpu#cpu_state.a).
...
ld_mem_nn_hl_test() ->
    ...
    Mem0 = Machine0#machine_state.memory,
    Mem1 = ezx_memory_48:cpu_write_byte(Mem0, 0, 16#22),  %% LD (nn),HL
    Mem2 = ezx_memory_48:cpu_write_byte(Mem1, 1, 16#00),
    Mem3 = ezx_memory_48:cpu_write_byte(Mem2, 2, 16#80),
    Machine1 = Machine0#machine_state{cpu = Cpu0, memory = Mem3},
    Machine2 = z80_cpu:step(Machine1),
    ?assertEqual(16#34, ezx_emulator:read_byte(Machine2, 16#8000)),
    ?assertEqual(16#12, ezx_emulator:read_byte(Machine2, 16#8001)),
    ?assertEqual(3, z80_cpu:pc(Machine2)).

ld_hl_mem_nn_test() ->
    Machine0 = ezx_emulator:init(),
    Mem0 = Machine0#machine_state.memory,
    Mem1 = ezx_memory_48:cpu_write_byte(Mem0, 16#8000, 16#34),
    Mem2 = ezx_memory_48:cpu_write_byte(Mem1, 16#8001, 16#12),
    Cpu0 = Machine0#machine_state.cpu,
    Machine1 = Machine0#machine_state{cpu = Cpu0, memory = Mem2},
    Mem3 = ezx_memory_48:cpu_write_byte(Mem2, 0, 16#2A),  %% LD HL,(nn)
    Mem4 = ezx_memory_48:cpu_write_byte(Mem3, 1, 16#00),
    Mem5 = ezx_memory_48:cpu_write_byte(Mem4, 2, 16#80),
...
ld_mem_nn_a_test() ->
    ...
    Mem0 = Machine0#machine_state.memory,
    Mem1 = ezx_memory_48:cpu_write_byte(Mem0, 0, 16#32),  %% LD (nn),A
    Mem2 = ezx_memory_48:cpu_write_byte(Mem1, 1, 16#00),
    Mem3 = ezx_memory_48:cpu_write_byte(Mem2, 2, 16#80),
    Machine1 = Machine0#machine_state{cpu = Cpu0, memory = Mem3},
    Machine2 = z80_cpu:step(Machine1),
    ?assertEqual(16#55, ezx_emulator:read_byte(Machine2, 16#8000)),
    ?assertEqual(3, z80_cpu:pc(Machine2)).

ld_a_mem_nn_test() ->
    Machine0 = ezx_emulator:init(),
    Mem0 = Machine0#machine_state.memory,
    Mem1 = ezx_memory_48:cpu_write_byte(Mem0, 16#8000, 16#AA),
    Cpu0 = Machine0#machine_state.cpu,
    Machine1 = Machine0#machine_state{cpu = Cpu0, memory = Mem1},
    Mem2 = ezx_memory_48:cpu_write_byte(Mem1, 0, 16#3A),  %% LD A,(nn)
    Mem3 = ezx_memory_48:cpu_write_byte(Mem2, 1, 16#00),
    Mem4 = ezx_memory_48:cpu_write_byte(Mem3, 2, 16#80),
...
ld_sp_hl_test() ->
    ...
    Cpu0 = Machine0#machine_state.cpu#cpu_state{h = 16#12, l = 16#34},
    Mem0 = Machine0#machine_state.memory,
    Mem1 = ezx_memory_48:cpu_write_byte(Mem0, 0, 16#F9),  %% LD SP,HL
    Machine1 = Machine0#machine_state{cpu = Cpu0, memory = Mem1},
    Machine2 = z80_cpu:step(Machine1),
