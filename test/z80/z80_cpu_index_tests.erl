...
dd_ld_ix_nn_test() ->
    ...
    Machine1 = z80_emulator:write_byte(Machine0, 0, 16#DD),
    Machine2 = z80_emulator:write_byte(Machine1, 1, 16#21),
    Machine3 = z80_emulator:write_byte(Machine2, 2, 16#34),
    Machine4 = z80_emulator:write_byte(Machine3, 3, 16#12),
...
dd_add_ix_bc_test() ->
    ...
    Machine2 = z80_emulator:write_byte(Machine1, 0, 16#DD),
    Machine3 = z80_emulator:write_byte(Machine2, 1, 16#09),
...
dd_inc_ix_test() ->
    ...
    Machine1 = Machine0#machine_state{cpu = Cpu0},
    Machine2 = z80_emulator:write_byte(Machine1, 0, 16#DD),
    Machine3 = z80_emulator:write_byte(Machine2, 1, 16#23),
    Machine4 = z80_cpu:step(Machine3),
...
dd_dec_ix_test() ->
    ...
    Machine1 = Machine0#machine_state{cpu = Cpu0},
    Machine2 = z80_emulator:write_byte(Machine1, 0, 16#DD),
    Machine3 = z80_emulator:write_byte(Machine2, 1, 16#2B),
    Machine4 = z80_cpu:step(Machine3),
    ?assertEqual(16#12, Machine4#machine_state.cpu#cpu_state.ixh),
...
dd_push_ix_test() ->
    ...
    Machine1 = Machine0#machine_state{cpu = Cpu0},
    Machine2 = z80_emulator:write_byte(Machine1, 0, 16#DD),
    Machine3 = z80_emulator:write_byte(Machine2, 1, 16#E5),
    Machine4 = z80_cpu:step(Machine3),
    ?assertEqual(16#FEFE, Machine4#machine_state.cpu#cpu_state.sp),
    ?assertEqual(16#34, z80_emulator:read_byte(Machine4, 16#FEFE)),
    ?assertEqual(16#12, z80_emulator:read_byte(Machine4, 16#FEFF)),
    ?assertEqual(2, z80_cpu:pc(Machine4)),
    ?assertEqual(15, z80_cpu:t_states(Machine4)).

dd_pop_ix_test() ->
    Machine0 = z80_emulator:init(),
    Machine1 = z80_emulator:write_byte(Machine0, 16#FEFE, 16#56),
    Machine2 = z80_emulator:write_byte(Machine1, 16#FEFF, 16#78),
    Cpu0 = Machine2#machine_state.cpu#cpu_state{sp = 16#FEFE},
    Machine3 = Machine2#machine_state{cpu = Cpu0},
    Machine4 = z80_emulator:write_byte(Machine3, 0, 16#DD),
    Machine5 = z80_emulator:write_byte(Machine4, 1, 16#E1),
...
dd_ld_sp_ix_test() ->
    ...
    Machine1 = Machine0#machine_state{cpu = Cpu0},
    Machine2 = z80_emulator:write_byte(Machine1, 0, 16#DD),
    Machine3 = z80_emulator:write_byte(Machine2, 1, 16#F9),
    Machine4 = z80_cpu:step(Machine3),
...
fd_ld_iy_nn_test() ->
    Machine0 = z80_emulator:init(),
    Machine1 = z80_emulator:write_byte(Machine0, 0, 16#FD),
    Machine2 = z80_emulator:write_byte(Machine1, 1, 16#21),
    Machine3 = z80_emulator:write_byte(Machine2, 2, 16#56),
    Machine4 = z80_emulator:write_byte(Machine3, 3, 16#78),
    Machine5 = z80_cpu:step(Machine4),
...
fd_add_iy_de_test() ->
    ...
    Machine1 = Machine0#machine_state{cpu = Cpu0},
    Machine2 = z80_emulator:write_byte(Machine1, 0, 16#FD),
    Machine3 = z80_emulator:write_byte(Machine2, 1, 16#19),
    Machine4 = z80_cpu:step(Machine3),
...
fd_pop_iy_test() ->
    ...
    Cpu0 = Machine2#machine_state.cpu#cpu_state{sp = 16#FEFE},
    Machine3 = Machine2#machine_state{cpu = Cpu0},
    Machine4 = z80_emulator:write_byte(Machine3, 0, 16#FD),
    Machine5 = z80_emulator:write_byte(Machine4, 1, 16#E1),
    Machine6 = z80_cpu:step(Machine5),
...
dd_prefix_cleared_after_instruction_test() ->
    ...
    Machine0 = z80_emulator:init(),
    Machine1 = z80_emulator:write_byte(Machine0, 0, 16#DD),
    Machine2 = z80_emulator:write_byte(Machine1, 1, 16#21),  %% LD IX,nn
    Machine3 = z80_emulator:write_byte(Machine2, 2, 16#34),
    Machine4 = z80_emulator:write_byte(Machine3, 3, 16#12),
    Machine5 = z80_cpu:step(Machine4),
...
fd_prefix_cleared_after_instruction_test() ->
    Machine0 = z80_emulator:init(),
    Machine1 = z80_emulator:write_byte(Machine0, 0, 16#FD),
    Machine2 = z80_emulator:write_byte(Machine1, 1, 16#21),  %% LD IY,nn
    Machine3 = z80_emulator:write_byte(Machine2, 2, 16#56),
    Machine4 = z80_emulator:write_byte(Machine3, 3, 16#78),
    Machine5 = z80_cpu:step(Machine4),
    ?assertEqual(none, Machine5#machine_state.cpu#cpu_state.prefix),
...
dd_dd_prefix_behavior_test() ->
    ...
    Machine0 = z80_emulator:init(),
    Machine1 = z80_emulator:write_byte(Machine0, 0, 16#DD),
    Machine2 = z80_emulator:write_byte(Machine1, 1, 16#DD),
    Machine3 = z80_emulator:write_byte(Machine2, 2, 16#21),
    Machine4 = z80_emulator:write_byte(Machine3, 3, 16#34),
    Machine5 = z80_emulator:write_byte(Machine4, 4, 16#12),
    Machine6 = z80_cpu:step(Machine5),
...
fd_fd_prefix_behavior_test() ->
    Machine0 = z80_emulator:init(),
    Machine1 = z80_emulator:write_byte(Machine0, 0, 16#FD),
    Machine2 = z80_emulator:write_byte(Machine1, 1, 16#FD),
    Machine3 = z80_emulator:write_byte(Machine2, 2, 16#21),
    Machine4 = z80_emulator:write_byte(Machine3, 3, 16#56),
    Machine5 = z80_emulator:write_byte(Machine4, 4, 16#78),
    Machine6 = z80_cpu:step(Machine5),
    ?assertEqual(16#78, Machine6#machine_state.cpu#cpu_state.iyh),
    ?assertEqual(16#56, Machine6#machine_state.cpu#cpu_state.iyl),
    ?assertEqual(none, Machine6#machine_state.cpu#cpu_state.prefix).
...
dd_ld_ixh_n_test() ->
    Machine0 = z80_emulator:init(),
    Machine1 = z80_emulator:write_byte(Machine0, 0, 16#DD),
    Machine2 = z80_emulator:write_byte(Machine1, 1, 16#26),  %% LD IXH,n
    Machine3 = z80_emulator:write_byte(Machine2, 2, 16#42),
    Machine4 = z80_cpu:step(Machine3),
...
dd_ld_ixl_n_test() ->
    Machine0 = z80_emulator:init(),
    Machine1 = z80_emulator:write_byte(Machine0, 0, 16#DD),
    Machine2 = z80_emulator:write_byte(Machine1, 1, 16#2E),  %% LD IXL,n
    Machine3 = z80_emulator:write_byte(Machine2, 2, 16#37),
    Machine4 = z80_cpu:step(Machine3),
...
fd_ld_iyh_n_test() ->
    Machine0 = z80_emulator:init(),
    Machine1 = z80_emulator:write_byte(Machine0, 0, 16#FD),
    Machine2 = z80_emulator:write_byte(Machine1, 1, 16#26),  %% LD IYH,n
    Machine3 = z80_emulator:write_byte(Machine2, 2, 16#55),
    Machine4 = z80_cpu:step(Machine3),
...
fd_ld_iyl_n_test() ->
    Machine0 = z80_emulator:init(),
    Machine1 = z80_emulator:write_byte(Machine0, 0, 16#FD),
    Machine2 = z80_emulator:write_byte(Machine1, 1, 16#2E),  %% LD IYL,n
    Machine3 = z80_emulator:write_byte(Machine2, 2, 16#66),
    Machine4 = z80_cpu:step(Machine3),
...
dd_ld_ixh_ixl_test() ->
    ...
    Machine1 = Machine0#machine_state{cpu = Cpu0},
    Machine2 = z80_emulator:write_byte(Machine1, 0, 16#DD),
    Machine3 = z80_emulator:write_byte(Machine2, 1, 16#65),  %% LD IXH, IXL (DD 65)
    Machine4 = z80_cpu:step(Machine3),
...
dd_ld_ixl_ixh_test() ->
    ...
    Machine1 = Machine0#machine_state{cpu = Cpu0},
    Machine2 = z80_emulator:write_byte(Machine1, 0, 16#DD),
    Machine3 = z80_emulator:write_byte(Machine2, 1, 16#6D),  %% LD IXL, IXL (DD 6D)
    Machine4 = z80_cpu:step(Machine3),
    ?assertEqual(16#12, Machine4#machine_state.cpu#cpu_state.ixh),
    ?assertEqual(16#34, Machine4#machine_state.cpu#cpu_state.ixl),
    ?assertEqual(none, Machine4#machine_state.cpu#cpu_state.prefix).
...
dd_inc_ixh_test() ->
    ...
    Machine1 = Machine0#machine_state{cpu = Cpu0},
    Machine2 = z80_emulator:write_byte(Machine1, 0, 16#DD),
    Machine3 = z80_emulator:write_byte(Machine2, 1, 16#24),  %% INC IXH
    Machine4 = z80_cpu:step(Machine3),
...
dd_inc_ixl_test() ->
    ...
    Machine1 = Machine0#machine_state{cpu = Cpu0},
    Machine2 = z80_emulator:write_byte(Machine1, 0, 16#DD),
    Machine3 = z80_emulator:write_byte(Machine2, 1, 16#2C),  %% INC IXL
    Machine4 = z80_cpu:step(Machine3),
    ?assertEqual(16#12, Machine4#machine_state.cpu#cpu_state.ixh),
    ?assertEqual(16#35, Machine4#machine_state.cpu#cpu_state.ixl),
    ?assertEqual(none, Machine4#machine_state.cpu#cpu_state.prefix).
...
dd_add_ix_ix_test() ->
    ...
    Machine1 = Machine0#machine_state{cpu = Cpu0},
    Machine2 = z80_emulator:write_byte(Machine1, 0, 16#DD),
    Machine3 = z80_emulator:write_byte(Machine2, 1, 16#29),  %% ADD IX,IX
    Machine4 = z80_cpu:step(Machine3),
...
fd_add_iy_iy_test() ->
    ...
    Machine1 = Machine0#machine_state{cpu = Cpu0},
    Machine2 = z80_emulator:write_byte(Machine1, 0, 16#FD),
    Machine3 = z80_emulator:write_byte(Machine2, 1, 16#29),  %% ADD IY,IY
    Machine4 = z80_cpu:step(Machine3),
...
dd_add_ix_sp_test() ->
    ...
    Machine1 = Machine0#machine_state{cpu = Cpu0},
    Machine2 = z80_emulator:write_byte(Machine1, 0, 16#DD),
    Machine3 = z80_emulator:write_byte(Machine2, 1, 16#39),  %% ADD IX,SP
    Machine4 = z80_cpu:step(Machine3),
...
fd_add_iy_sp_test() ->
    ...
    Machine1 = Machine0#machine_state{cpu = Cpu0},
    Machine2 = z80_emulator:write_byte(Machine1, 0, 16#FD),
    Machine3 = z80_emulator:write_byte(Machine2, 1, 16#39),  %% ADD IY,SP
    Machine4 = z80_cpu:step(Machine3),
    ?assertEqual(16#30, Machine4#machine_state.cpu#cpu_state.iyh),
    ?assertEqual(16#00, Machine4#machine_state.cpu#cpu_state.iyl),
    ?assertEqual(none, Machine4#machine_state.cpu#cpu_state.prefix).
...
dd_ex_de_ix_test() ->
    ...
    Machine1 = Machine0#machine_state{cpu = Cpu0},
    Machine2 = z80_emulator:write_byte(Machine1, 0, 16#DD),
    Machine3 = z80_emulator:write_byte(Machine2, 1, 16#EB),  %% EX DE,IX
    Machine4 = z80_cpu:step(Machine3),
...
fd_ex_de_iy_test() ->
    ...
    Machine1 = Machine0#machine_state{cpu = Cpu0},
    Machine2 = z80_emulator:write_byte(Machine1, 0, 16#FD),
    Machine3 = z80_emulator:write_byte(Machine2, 1, 16#EB),  %% EX DE,IY
    Machine4 = z80_cpu:step(Machine3),
...
dd_jp_ix_test() ->
    ...
    Machine1 = Machine0#machine_state{cpu = Cpu0},
    Machine2 = z80_emulator:write_byte(Machine1, 0, 16#DD),
    Machine3 = z80_emulator:write_byte(Machine2, 1, 16#E9),  %% JP (IX)
    Machine4 = z80_cpu:step(Machine3),
...
fd_jp_iy_test() ->
    ...
    Machine1 = Machine0#machine_state{cpu = Cpu0},
    Machine2 = z80_emulator:write_byte(Machine1, 0, 16#FD),
    Machine3 = z80_emulator:write_byte(Machine2, 1, 16#E9),  %% JP (IY)
    Machine4 = z80_cpu:step(Machine3),
...
dd_ex_sp_ix_test() ->
    %% EX (SP),IX (DD E3)
    Machine0 = z80_emulator:init(),
    Machine1 = z80_emulator:write_byte(Machine0, 16#FF00, 16#12),
    Machine2 = z80_emulator:write_byte(Machine1, 16#FF01, 16#34),
    Cpu0 = Machine2#machine_state.cpu#cpu_state{ixh = 16#56, ixl = 16#78, sp = 16#FF00},
    Machine3 = Machine2#machine_state{cpu = Cpu0},
    Machine4 = z80_emulator:write_byte(Machine3, 0, 16#DD),
    Machine5 = z80_emulator:write_byte(Machine4, 1, 16#E3),  %% EX (SP),IX
    Machine6 = z80_cpu:step(Machine5),
    ...
    ?assertEqual(16#78, z80_emulator:read_byte(Machine6, 16#FF00)),
    ?assertEqual(16#56, z80_emulator:read_byte(Machine6, 16#FF01)),
    ?assertEqual(none, Machine6#machine_state.cpu#cpu_state.prefix),
...
fd_ex_sp_iy_test() ->
    %% EX (SP),IY (FD E3)
    Machine0 = z80_emulator:init(),
    Machine1 = z80_emulator:write_byte(Machine0, 16#FF00, 16#9A),
    Machine2 = z80_emulator:write_byte(Machine1, 16#FF01, 16#BC),
    Cpu0 = Machine2#machine_state.cpu#cpu_state{iyh = 16#DE, iyl = 16#F0, sp = 16#FF00},
    Machine3 = Machine2#machine_state{cpu = Cpu0},
    Machine4 = z80_emulator:write_byte(Machine3, 0, 16#FD),
    Machine5 = z80_emulator:write_byte(Machine4, 1, 16#E3),  %% EX (SP),IY
    Machine6 = z80_cpu:step(Machine5),
    ...
    ?assertEqual(16#F0, z80_emulator:read_byte(Machine6, 16#FF00)),
    ?assertEqual(16#DE, z80_emulator:read_byte(Machine6, 16#FF01)),
    ?assertEqual(none, Machine6#machine_state.cpu#cpu_state.prefix),
    ?assertEqual(23, z80_cpu:t_states(Machine6)).
...
dd_ld_r_mem_ix_test() ->
    ...
    Machine0 = z80_emulator:init(),
    Machine1 = z80_emulator:write_byte(Machine0, 16#4000, 16#55),
    Cpu0 = Machine1#machine_state.cpu#cpu_state{ixh = 16#40, ixl = 16#00},
    Machine2 = Machine1#machine_state{cpu = Cpu0},
    Machine3 = z80_emulator:write_byte(Machine2, 0, 16#DD),
    Machine4 = z80_emulator:write_byte(Machine3, 1, 16#46),  %% LD B,(IX+0)
    Machine5 = z80_emulator:write_byte(Machine4, 2, 16#00),  %% displacement 0
    Machine6 = z80_cpu:step(Machine5),
...
dd_ld_r_mem_ix_disp_test() ->
    ...
    Machine0 = z80_emulator:init(),
    Machine1 = z80_emulator:write_byte(Machine0, 16#4005, 16#AA),
    Cpu0 = Machine1#machine_state.cpu#cpu_state{ixh = 16#40, ixl = 16#00},
    Machine2 = Machine1#machine_state{cpu = Cpu0},
    Machine3 = z80_emulator:write_byte(Machine2, 0, 16#DD),
    Machine4 = z80_emulator:write_byte(Machine3, 1, 16#4E),  %% LD C,(IX+d)
    Machine5 = z80_emulator:write_byte(Machine4, 2, 16#05),  %% displacement +5
    Machine6 = z80_cpu:step(Machine5),
...
fd_ld_r_mem_iy_test() ->
    ...
    Machine0 = z80_emulator:init(),
    Machine1 = z80_emulator:write_byte(Machine0, 16#5000, 16#CC),
    Cpu0 = Machine1#machine_state.cpu#cpu_state{iyh = 16#50, iyl = 16#00},
    Machine2 = Machine1#machine_state{cpu = Cpu0},
    Machine3 = z80_emulator:write_byte(Machine2, 0, 16#FD),
    Machine4 = z80_emulator:write_byte(Machine3, 1, 16#56),  %% LD D,(IY+0)
    Machine5 = z80_emulator:write_byte(Machine4, 2, 16#00),
    Machine6 = z80_cpu:step(Machine5),
...
dd_ld_mem_ix_r_test() ->
    ...
    Machine1 = Machine0#machine_state{cpu = Cpu0},
    Machine2 = z80_emulator:write_byte(Machine1, 0, 16#DD),
    Machine3 = z80_emulator:write_byte(Machine2, 1, 16#70),  %% LD (IX+d),B
    Machine4 = z80_emulator:write_byte(Machine3, 2, 16#03),  %% displacement +3
    Machine5 = z80_cpu:step(Machine4),
    ?assertEqual(16#EE, z80_emulator:read_byte(Machine5, 16#4003)),
    ?assertEqual(none, Machine5#machine_state.cpu#cpu_state.prefix).