...
push_bc_test() ->
    ...
    Mem1 = ezx_mem:write_byte(Mem0, 0, 16#C5),  %% PUSH BC
...
push_de_test() ->
    ...
    Mem0 = Machine0#machine_state.memory,
    Mem1 = ezx_mem:write_byte(Mem0, 0, 16#D5),  %% PUSH DE
    Machine1 = Machine0#machine_state{cpu = Cpu0, memory = Mem1},
    Machine2 = z80_cpu:step(Machine1),
    ?assertEqual(16#FEFE, Machine2#machine_state.cpu#cpu_state.sp),
...
push_hl_test() ->
    ...
    Mem0 = Machine0#machine_state.memory,
    Mem1 = ezx_mem:write_byte(Mem0, 0, 16#E5),  %% PUSH HL
    Machine1 = Machine0#machine_state{cpu = Cpu0, memory = Mem1},
    Machine2 = z80_cpu:step(Machine1),
    ?assertEqual(16#FEFE, Machine2#machine_state.cpu#cpu_state.sp),
...
push_af_test() ->
    ...
    Mem0 = Machine0#machine_state.memory,
    Mem1 = ezx_mem:write_byte(Mem0, 0, 16#F5),  %% PUSH AF
    Machine1 = Machine0#machine_state{cpu = Cpu0, memory = Mem1},
    Machine2 = z80_cpu:step(Machine1),
    ?assertEqual(16#FEFE, Machine2#machine_state.cpu#cpu_state.sp),
...
push_sp_test() ->
    ...
    Mem0 = Machine0#machine_state.memory,
    Mem1 = ezx_mem:write_byte(Mem0, 0, 16#F5),  %% PUSH AF (using as placeholder)
    Machine1 = Machine0#machine_state{cpu = Cpu0, memory = Mem1},
...
pop_bc_test() ->
    Machine0 = ezx_emulator:init(),
    Mem0 = Machine0#machine_state.memory,
    Mem1 = ezx_mem:write_byte(Mem0, 16#FEFE, 16#34),
    Mem2 = ezx_mem:write_byte(Mem1, 16#FEFF, 16#12),
    Cpu0 = Machine0#machine_state.cpu#cpu_state{sp = 16#FEFE},
    Machine1 = Machine0#machine_state{cpu = Cpu0, memory = Mem2},
    Mem3 = ezx_mem:write_byte(Mem2, 0, 16#C1),  %% POP BC
...
pop_de_test() ->
    Machine0 = ezx_emulator:init(),
    Mem0 = Machine0#machine_state.memory,
    Mem1 = ezx_mem:write_byte(Mem0, 16#FEFE, 16#78),
    Mem2 = ezx_mem:write_byte(Mem1, 16#FEFF, 16#56),
    Cpu0 = Machine0#machine_state.cpu#cpu_state{sp = 16#FEFE},
    Machine1 = Machine0#machine_state{cpu = Cpu0, memory = Mem2},
    Mem3 = ezx_mem:write_byte(Mem2, 0, 16#D1),  %% POP DE
    Machine2 = Machine1#machine_state{memory = Mem3},
    Machine3 = z80_cpu:step(Machine2),
...
pop_hl_test() ->
    Machine0 = ezx_emulator:init(),
    Mem0 = Machine0#machine_state.memory,
    Mem1 = ezx_mem:write_byte(Mem0, 16#FEFE, 16#BC),
    Mem2 = ezx_mem:write_byte(Mem1, 16#FEFF, 16#9A),
    Cpu0 = Machine0#machine_state.cpu#cpu_state{sp = 16#FEFE},
    Machine1 = Machine0#machine_state{cpu = Cpu0, memory = Mem2},
    Mem3 = ezx_mem:write_byte(Mem2, 0, 16#E1),  %% POP HL
    Machine2 = Machine1#machine_state{memory = Mem3},
    Machine3 = z80_cpu:step(Machine2),
...
pop_af_test() ->
    Machine0 = ezx_emulator:init(),
    Mem0 = Machine0#machine_state.memory,
    Mem1 = ezx_mem:write_byte(Mem0, 16#FEFE, 16#F0),
    Mem2 = ezx_mem:write_byte(Mem1, 16#FEFF, 16#DE),
    Cpu0 = Machine0#machine_state.cpu#cpu_state{sp = 16#FEFE},
    Machine1 = Machine0#machine_state{cpu = Cpu0, memory = Mem2},
    Mem3 = ezx_mem:write_byte(Mem2, 0, 16#F1),  %% POP AF
    Machine2 = Machine1#machine_state{memory = Mem3},
    Machine3 = z80_cpu:step(Machine2),
...
ret_test() ->
    Machine0 = ezx_emulator:init(),
    Mem0 = Machine0#machine_state.memory,
    Mem1 = ezx_mem:write_byte(Mem0, 16#FEFE, 16#00),
    Mem2 = ezx_mem:write_byte(Mem1, 16#FEFF, 16#80),
    Cpu0 = Machine0#machine_state.cpu#cpu_state{sp = 16#FEFE},
    Machine1 = Machine0#machine_state{cpu = Cpu0, memory = Mem2},
    Mem3 = ezx_mem:write_byte(Mem2, 0, 16#C9),  %% RET
    Machine2 = Machine1#machine_state{memory = Mem3},
    Machine3 = z80_cpu:step(Machine2),
...
ret_nz_taken_test() ->
    ...
    Machine1 = Machine0#machine_state{cpu = Cpu0, memory = Mem2},
    Mem3 = ezx_mem:write_byte(Mem2, 0, 16#C0),  %% RET NZ
    Machine2 = Machine1#machine_state{memory = Mem3},
    Machine3 = z80_cpu:step(Machine2),
    ?assertEqual(16#8000, z80_cpu:pc(Machine3)),
...
ret_z_taken_test() ->
    ...
    Cpu0 = Machine0#machine_state.cpu#cpu_state{sp = 16#FEFE, f = 16#40},
    Machine1 = Machine0#machine_state{cpu = Cpu0, memory = Mem2},
    Mem3 = ezx_mem:write_byte(Mem2, 0, 16#C8),  %% RET Z
    Machine2 = Machine1#machine_state{memory = Mem3},
    Machine3 = z80_cpu:step(Machine2),
    ?assertEqual(16#8000, z80_cpu:pc(Machine3)).
...
ret_nc_taken_test() ->
    ...
    Cpu0 = Machine0#machine_state.cpu#cpu_state{sp = 16#FEFE, f = 0},
    Machine1 = Machine0#machine_state{cpu = Cpu0, memory = Mem2},
    Mem3 = ezx_mem:write_byte(Mem2, 0, 16#D0),  %% RET NC
    Machine2 = Machine1#machine_state{memory = Mem3},
    Machine3 = z80_cpu:step(Machine2),
    ?assertEqual(16#8000, z80_cpu:pc(Machine3)).
...
ret_c_taken_test() ->
    ...
    Machine1 = Machine0#machine_state{cpu = Cpu0, memory = Mem2},
    Mem3 = ezx_mem:write_byte(Mem2, 0, 16#D8),  %% RET C
    Machine2 = Machine1#machine_state{memory = Mem3},
    Machine3 = z80_cpu:step(Machine2),
    ?assertEqual(16#8000, z80_cpu:pc(Machine3)).
...
ret_po_taken_test() ->
    ...
    Cpu0 = Machine0#machine_state.cpu#cpu_state{sp = 16#FEFE, f = 0},
    Machine1 = Machine0#machine_state{cpu = Cpu0, memory = Mem2},
    Mem3 = ezx_mem:write_byte(Mem2, 0, 16#E0),  %% RET PO
    Machine2 = Machine1#machine_state{memory = Mem3},
    Machine3 = z80_cpu:step(Machine2),
    ?assertEqual(16#8000, z80_cpu:pc(Machine3)).
...
ret_pe_taken_test() ->
    ...
    Machine1 = Machine0#machine_state{cpu = Cpu0, memory = Mem2},
    Mem3 = ezx_mem:write_byte(Mem2, 0, 16#E8),  %% RET PE
    Machine2 = Machine1#machine_state{memory = Mem3},
    Machine3 = z80_cpu:step(Machine2),
    ?assertEqual(16#8000, z80_cpu:pc(Machine3)).
...
ret_p_taken_test() ->
    ...
    Cpu0 = Machine0#machine_state.cpu#cpu_state{sp = 16#FEFE, f = 0},
    Machine1 = Machine0#machine_state{cpu = Cpu0, memory = Mem2},
    Mem3 = ezx_mem:write_byte(Mem2, 0, 16#F0),  %% RET P
    Machine2 = Machine1#machine_state{memory = Mem3},
    Machine3 = z80_cpu:step(Machine2),
    ?assertEqual(16#8000, z80_cpu:pc(Machine3)).
...
ret_m_taken_test() ->
    ...
    Machine1 = Machine0#machine_state{cpu = Cpu0, memory = Mem2},
    Mem3 = ezx_mem:write_byte(Mem2, 0, 16#F8),  %% RET M
    Machine2 = Machine1#machine_state{memory = Mem3},
    Machine3 = z80_cpu:step(Machine2),
    ?assertEqual(16#8000, z80_cpu:pc(Machine3)).
...
rst_00_test() ->
    ...
    Mem0 = Machine0#machine_state.memory,
    Mem1 = ezx_mem:write_byte(Mem0, 16#0005, 16#C7),  %% RST 00h
    Machine1 = Machine0#machine_state{cpu = Cpu0, memory = Mem1},
    Machine2 = z80_cpu:step(Machine1),
