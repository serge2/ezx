...
dd_cb_rlc_ix_zero_disp_test() ->
    ...
    Mem1 = z80_mem:write_byte(Mem0, 16#4000, 16#80),           %% value at (IX+0)
    Mem2 = z80_mem:write_byte(Mem1, 0, 16#DD),                 %% DD prefix
    Mem3 = z80_mem:write_byte(Mem2, 1, 16#CB),                 %% CB prefix
    Mem4 = z80_mem:write_byte(Mem3, 2, 16#00),                 %% displacement 0
    Mem5 = z80_mem:write_byte(Mem4, 3, 16#06),                 %% RLC (IX+0)
    ...
    ?assertEqual(16#01, z80_mem:read_byte(Machine2#machine_state.memory, 16#4000)),
...
dd_cb_rlc_ix_pos_disp_test() ->
    ...
    Machine0 = z80_emulator:init(),
    Mem0 = Machine0#machine_state.memory,
    Mem1 = z80_mem:write_byte(Mem0, 16#4005, 16#40),           %% value at (IX+5)
    Mem2 = z80_mem:write_byte(Mem1, 0, 16#DD),                 %% DD prefix
    Mem3 = z80_mem:write_byte(Mem2, 1, 16#CB),                 %% CB prefix
    Mem4 = z80_mem:write_byte(Mem3, 2, 16#05),                 %% displacement +5
    Mem5 = z80_mem:write_byte(Mem4, 3, 16#06),                 %% RLC (IX+5)
    Machine1 = Machine0#machine_state{memory = Mem5, cpu = Machine0#machine_state.cpu#cpu_state{ixh = 16#40, ixl = 16#00}},
    Machine2 = z80_cpu:step(Machine1),
    ?assertEqual(16#80, z80_mem:read_byte(Machine2#machine_state.memory, 16#4005)),
...
dd_cb_rlc_ix_neg_disp_test() ->
    ...
    Machine0 = z80_emulator:init(),
    Mem0 = Machine0#machine_state.memory,
    Mem1 = z80_mem:write_byte(Mem0, 16#3FFF, 16#01),           %% value at (IX-1)
    Mem2 = z80_mem:write_byte(Mem1, 0, 16#DD),                 %% DD prefix
    Mem3 = z80_mem:write_byte(Mem2, 1, 16#CB),                 %% CB prefix
    Mem4 = z80_mem:write_byte(Mem3, 2, 16#FF),                 %% displacement -1 (0xFF)
    Mem5 = z80_mem:write_byte(Mem4, 3, 16#06),                 %% RLC (IX-1)
    Machine1 = Machine0#machine_state{memory = Mem5, cpu = Machine0#machine_state.cpu#cpu_state{ixh = 16#40, ixl = 16#00}},
    Machine2 = z80_cpu:step(Machine1),
    ?assertEqual(16#02, z80_mem:read_byte(Machine2#machine_state.memory, 16#3FFF)),
    ?assertEqual(0, Machine2#machine_state.cpu#cpu_state.f band ?FLAG_C).
...
dd_cb_rlc_ix_zero_result_test() ->
    ...
    Machine0 = z80_emulator:init(),
    Mem0 = Machine0#machine_state.memory,
    Mem1 = z80_mem:write_byte(Mem0, 16#4000, 16#00),           %% value at (IX+0)
    Mem2 = z80_mem:write_byte(Mem1, 0, 16#DD),                 %% DD prefix
    Mem3 = z80_mem:write_byte(Mem2, 1, 16#CB),                 %% CB prefix
    Mem4 = z80_mem:write_byte(Mem3, 2, 16#00),                 %% displacement 0
    Mem5 = z80_mem:write_byte(Mem4, 3, 16#06),                 %% RLC (IX+0)
    Machine1 = Machine0#machine_state{memory = Mem5, cpu = Machine0#machine_state.cpu#cpu_state{ixh = 16#40, ixl = 16#00}},
    Machine2 = z80_cpu:step(Machine1),
    ?assertEqual(16#00, z80_mem:read_byte(Machine2#machine_state.memory, 16#4000)),
...
fd_cb_rlc_iy_test() ->
    ...
    Machine0 = z80_emulator:init(),
    Mem0 = Machine0#machine_state.memory,
    Mem1 = z80_mem:write_byte(Mem0, 16#5000, 16#80),           %% value at (IY+0)
    Mem2 = z80_mem:write_byte(Mem1, 0, 16#FD),                 %% FD prefix
    Mem3 = z80_mem:write_byte(Mem2, 1, 16#CB),                 %% CB prefix
    Mem4 = z80_mem:write_byte(Mem3, 2, 16#00),                 %% displacement 0
    Mem5 = z80_mem:write_byte(Mem4, 3, 16#06),                 %% RLC (IY+0)
    Machine1 = Machine0#machine_state{memory = Mem5, cpu = Machine0#machine_state.cpu#cpu_state{iyh = 16#50, iyl = 16#00}},
    Machine2 = z80_cpu:step(Machine1),
    ?assertEqual(16#01, z80_mem:read_byte(Machine2#machine_state.memory, 16#5000)),
    ?assertEqual(?FLAG_C, Machine2#machine_state.cpu#cpu_state.f band ?FLAG_C).
...
dd_cb_rrc_ix_test() ->
    ...
    Machine0 = z80_emulator:init(),
    Mem0 = Machine0#machine_state.memory,
    Mem1 = z80_mem:write_byte(Mem0, 16#4000, 16#01),           %% value at (IX+0)
    Mem2 = z80_mem:write_byte(Mem1, 0, 16#DD),                 %% DD prefix
    Mem3 = z80_mem:write_byte(Mem2, 1, 16#CB),                 %% CB prefix
    Mem4 = z80_mem:write_byte(Mem3, 2, 16#00),                 %% displacement 0
    Mem5 = z80_mem:write_byte(Mem4, 3, 16#0E),                 %% RRC (IX+0)
    Machine1 = Machine0#machine_state{memory = Mem5, cpu = Machine0#machine_state.cpu#cpu_state{ixh = 16#40, ixl = 16#00}},
    Machine2 = z80_cpu:step(Machine1),
    ?assertEqual(16#80, z80_mem:read_byte(Machine2#machine_state.memory, 16#4000)),
    ?assertEqual(?FLAG_C, Machine2#machine_state.cpu#cpu_state.f band ?FLAG_C),
    ?assertEqual(?FLAG_S, Machine2#machine_state.cpu#cpu_state.f band ?FLAG_S).
...
dd_cb_rl_ix_test() ->
    ...
    Machine0 = z80_emulator:init(),
    Mem0 = Machine0#machine_state.memory,
    Mem1 = z80_mem:write_byte(Mem0, 16#4000, 16#7F),           %% value at (IX+0)
    Mem2 = z80_mem:write_byte(Mem1, 0, 16#DD),                 %% DD prefix
    Mem3 = z80_mem:write_byte(Mem2, 1, 16#CB),                 %% CB prefix
    Mem4 = z80_mem:write_byte(Mem3, 2, 16#00),                 %% displacement 0
    Mem5 = z80_mem:write_byte(Mem4, 3, 16#16),                 %% RL (IX+0)
    Machine1 = Machine0#machine_state{memory = Mem5, cpu = Machine0#machine_state.cpu#cpu_state{ixh = 16#40, ixl = 16#00, f = 0}},
    Machine2 = z80_cpu:step(Machine1),
    ?assertEqual(16#FE, z80_mem:read_byte(Machine2#machine_state.memory, 16#4000)),
    ?assertEqual(0, Machine2#machine_state.cpu#cpu_state.f band ?FLAG_C).
...
dd_cb_rl_ix_with_carry_test() ->
    ...
    Machine2 = z80_cpu:step(Machine1),
    ?assertEqual(16#FF, z80_mem:read_byte(Machine2#machine_state.memory, 16#4000)),
    ?assertEqual(0, Machine2#machine_state.cpu#cpu_state.f band ?FLAG_C).
...
dd_cb_rr_ix_test() ->
    ...
    Mem3 = z80_mem:write_byte(Mem2, 1, 16#CB),                 %% CB prefix
    Mem4 = z80_mem:write_byte(Mem3, 2, 16#00),                 %% displacement 0
    Mem5 = z80_mem:write_byte(Mem4, 3, 16#1E),                 %% RR (IX+0)
    Machine1 = Machine0#machine_state{memory = Mem5, cpu = Machine0#machine_state.cpu#cpu_state{ixh = 16#40, ixl = 16#00, f = 0}},
    Machine2 = z80_cpu:step(Machine1),
    ?assertEqual(16#00, z80_mem:read_byte(Machine2#machine_state.memory, 16#4000)),
    ?assertEqual(?FLAG_C, Machine2#machine_state.cpu#cpu_state.f band ?FLAG_C),
...
dd_cb_sla_ix_test() ->
    ...
    Machine0 = z80_emulator:init(),
    Mem0 = Machine0#machine_state.memory,
    Mem1 = z80_mem:write_byte(Mem0, 16#4000, 16#40),           %% value at (IX+0)
    Mem2 = z80_mem:write_byte(Mem1, 0, 16#DD),                 %% DD prefix
    Mem3 = z80_mem:write_byte(Mem2, 1, 16#CB),                 %% CB prefix
    Mem4 = z80_mem:write_byte(Mem3, 2, 16#00),                 %% displacement 0
    Mem5 = z80_mem:write_byte(Mem4, 3, 16#26),                 %% SLA (IX+0)
    Machine1 = Machine0#machine_state{memory = Mem5, cpu = Machine0#machine_state.cpu#cpu_state{ixh = 16#40, ixl = 16#00}},
    Machine2 = z80_cpu:step(Machine1),
    ?assertEqual(16#80, z80_mem:read_byte(Machine2#machine_state.memory, 16#4000)),
    ?assertEqual(?FLAG_S, Machine2#machine_state.cpu#cpu_state.f band ?FLAG_S).
...
dd_cb_sra_ix_test() ->
    ...
    Mem3 = z80_mem:write_byte(Mem2, 1, 16#CB),                 %% CB prefix
    Mem4 = z80_mem:write_byte(Mem3, 2, 16#00),                 %% displacement 0
    Mem5 = z80_mem:write_byte(Mem4, 3, 16#2E),                 %% SRA (IX+0)
    Machine1 = Machine0#machine_state{memory = Mem5, cpu = Machine0#machine_state.cpu#cpu_state{ixh = 16#40, ixl = 16#00}},
    Machine2 = z80_cpu:step(Machine1),
    ?assertEqual(16#C0, z80_mem:read_byte(Machine2#machine_state.memory, 16#4000)),
    ?assertEqual(?FLAG_S, Machine2#machine_state.cpu#cpu_state.f band ?FLAG_S).
...
dd_cb_sra_ix_positive_test() ->
    ...
    Machine0 = z80_emulator:init(),
    Mem0 = Machine0#machine_state.memory,
    Mem1 = z80_mem:write_byte(Mem0, 16#4000, 16#40),
    Mem2 = z80_mem:write_byte(Mem1, 0, 16#DD),
    Mem3 = z80_mem:write_byte(Mem2, 1, 16#CB),
    Mem4 = z80_mem:write_byte(Mem3, 2, 16#00),
    Mem5 = z80_mem:write_byte(Mem4, 3, 16#2E),
    Machine1 = Machine0#machine_state{memory = Mem5, cpu = Machine0#machine_state.cpu#cpu_state{ixh = 16#40, ixl = 16#00}},
    Machine2 = z80_cpu:step(Machine1),
    ?assertEqual(16#20, z80_mem:read_byte(Machine2#machine_state.memory, 16#4000)),
    ?assertEqual(0, Machine2#machine_state.cpu#cpu_state.f band ?FLAG_S).
...
dd_cb_sll_ix_test() ->
    ...
    Mem3 = z80_mem:write_byte(Mem2, 1, 16#CB),
    Mem4 = z80_mem:write_byte(Mem3, 2, 16#00),
    Mem5 = z80_mem:write_byte(Mem4, 3, 16#36),
    Machine1 = Machine0#machine_state{memory = Mem5, cpu = Machine0#machine_state.cpu#cpu_state{ixh = 16#40, ixl = 16#00}},
    Machine2 = z80_cpu:step(Machine1),
    ?assertEqual(16#81, z80_mem:read_byte(Machine2#machine_state.memory, 16#4000)),
    ?assertEqual(?FLAG_S, Machine2#machine_state.cpu#cpu_state.f band ?FLAG_S).
...
dd_cb_sll_ix_carry_test() ->
    ...
    Machine0 = z80_emulator:init(),
    Mem0 = Machine0#machine_state.memory,
    Mem1 = z80_mem:write_byte(Mem0, 16#4000, 16#80),
    Mem2 = z80_mem:write_byte(Mem1, 0, 16#DD),
    Mem3 = z80_mem:write_byte(Mem2, 1, 16#CB),
    Mem4 = z80_mem:write_byte(Mem3, 2, 16#00),
    Mem5 = z80_mem:write_byte(Mem4, 3, 16#36),
...
dd_cb_srl_ix_test() ->
    ...
    Mem3 = z80_mem:write_byte(Mem2, 1, 16#CB),
    Mem4 = z80_mem:write_byte(Mem3, 2, 16#00),
    Mem5 = z80_mem:write_byte(Mem4, 3, 16#3E),
    Machine1 = Machine0#machine_state{memory = Mem5, cpu = Machine0#machine_state.cpu#cpu_state{ixh = 16#40, ixl = 16#00}},
    Machine2 = z80_cpu:step(Machine1),
    ?assertEqual(16#40, z80_mem:read_byte(Machine2#machine_state.memory, 16#4000)),
    ?assertEqual(0, Machine2#machine_state.cpu#cpu_state.f band ?FLAG_S).
...
dd_cb_bit_0_ix_test() ->
    ...
    Mem3 = z80_mem:write_byte(Mem2, 1, 16#CB),
    Mem4 = z80_mem:write_byte(Mem3, 2, 16#00),
    Mem5 = z80_mem:write_byte(Mem4, 3, 16#46),
    Machine1 = Machine0#machine_state{memory = Mem5, cpu = Machine0#machine_state.cpu#cpu_state{ixh = 16#40, ixl = 16#00}},
    Machine2 = z80_cpu:step(Machine1),
    ?assertEqual(16#01, z80_mem:read_byte(Machine2#machine_state.memory, 16#4000)),
    ?assertEqual(0, Machine2#machine_state.cpu#cpu_state.f band ?FLAG_Z),
...
dd_cb_bit_7_ix_test() ->
    ...
    Mem3 = z80_mem:write_byte(Mem2, 1, 16#CB),
    Mem4 = z80_mem:write_byte(Mem3, 2, 16#00),
    Mem5 = z80_mem:write_byte(Mem4, 3, 16#7E),
    Machine1 = Machine0#machine_state{memory = Mem5, cpu = Machine0#machine_state.cpu#cpu_state{ixh = 16#40, ixl = 16#00}},
    Machine2 = z80_cpu:step(Machine1),
    ?assertEqual(0, Machine2#machine_state.cpu#cpu_state.f band ?FLAG_Z),
    ?assertEqual(?FLAG_S, Machine2#machine_state.cpu#cpu_state.f band ?FLAG_S).
...
dd_cb_bit_7_ix_zero_test() ->
    ...
    Machine0 = z80_emulator:init(),
    Mem0 = Machine0#machine_state.memory,
    Mem1 = z80_mem:write_byte(Mem0, 16#4000, 16#7F),
    Mem2 = z80_mem:write_byte(Mem1, 0, 16#DD),
    Mem3 = z80_mem:write_byte(Mem2, 1, 16#CB),
    Mem4 = z80_mem:write_byte(Mem3, 2, 16#00),
    Mem5 = z80_mem:write_byte(Mem4, 3, 16#7E),
...
dd_cb_bit_3_ix_test() ->
    ...
    Machine0 = z80_emulator:init(),
    Mem0 = Machine0#machine_state.memory,
    Mem1 = z80_mem:write_byte(Mem0, 16#4002, 16#08),
    Mem2 = z80_mem:write_byte(Mem1, 0, 16#DD),
    Mem3 = z80_mem:write_byte(Mem2, 1, 16#CB),
    Mem4 = z80_mem:write_byte(Mem3, 2, 16#02),
    Mem5 = z80_mem:write_byte(Mem4, 3, 16#5E),
    Machine1 = Machine0#machine_state{memory = Mem5, cpu = Machine0#machine_state.cpu#cpu_state{ixh = 16#40, ixl = 16#00}},
    Machine2 = z80_cpu:step(Machine1),
    ?assertEqual(0, Machine2#machine_state.cpu#cpu_state.f band ?FLAG_Z).
...
fd_cb_bit_iy_test() ->
    ...
    Machine0 = z80_emulator:init(),
    Mem0 = Machine0#machine_state.memory,
    Mem1 = z80_mem:write_byte(Mem0, 16#5003, 16#20),
    Mem2 = z80_mem:write_byte(Mem1, 0, 16#FD),
    Mem3 = z80_mem:write_byte(Mem2, 1, 16#CB),
    Mem4 = z80_mem:write_byte(Mem3, 2, 16#03),
    Mem5 = z80_mem:write_byte(Mem4, 3, 16#6E),
    Machine1 = Machine0#machine_state{memory = Mem5, cpu = Machine0#machine_state.cpu#cpu_state{iyh = 16#50, iyl = 16#00}},
    Machine2 = z80_cpu:step(Machine1),
    ?assertEqual(0, Machine2#machine_state.cpu#cpu_state.f band ?FLAG_Z).
...
dd_cb_res_0_ix_test() ->
    ...
    Mem3 = z80_mem:write_byte(Mem2, 1, 16#CB),
    Mem4 = z80_mem:write_byte(Mem3, 2, 16#00),
    Mem5 = z80_mem:write_byte(Mem4, 3, 16#86),
    Machine1 = Machine0#machine_state{memory = Mem5, cpu = Machine0#machine_state.cpu#cpu_state{ixh = 16#40, ixl = 16#00}},
    Machine2 = z80_cpu:step(Machine1),
    ?assertEqual(16#FE, z80_mem:read_byte(Machine2#machine_state.memory, 16#4000)).
...
dd_cb_res_7_ix_test() ->
    ...
    Mem3 = z80_mem:write_byte(Mem2, 1, 16#CB),
    Mem4 = z80_mem:write_byte(Mem3, 2, 16#00),
    Mem5 = z80_mem:write_byte(Mem4, 3, 16#BE),
    Machine1 = Machine0#machine_state{memory = Mem5, cpu = Machine0#machine_state.cpu#cpu_state{ixh = 16#40, ixl = 16#00}},
    Machine2 = z80_cpu:step(Machine1),
    ?assertEqual(16#7F, z80_mem:read_byte(Machine2#machine_state.memory, 16#4000)).

dd_cb_res_3_ix_test() ->
    %% RES 3,(IX+5): 0xFF -> 0xF7
    Machine0 = z80_emulator:init(),
    Mem0 = Machine0#machine_state.memory,
    Mem1 = z80_mem:write_byte(Mem0, 16#4005, 16#FF),
    Mem2 = z80_mem:write_byte(Mem1, 0, 16#DD),
    Mem3 = z80_mem:write_byte(Mem2, 1, 16#CB),
    Mem4 = z80_mem:write_byte(Mem3, 2, 16#05),
    Mem5 = z80_mem:write_byte(Mem4, 3, 16#9E),
    Machine1 = Machine0#machine_state{memory = Mem5, cpu = Machine0#machine_state.cpu#cpu_state{ixh = 16#40, ixl = 16#00}},
    Machine2 = z80_cpu:step(Machine1),
    ?assertEqual(16#F7, z80_mem:read_byte(Machine2#machine_state.memory, 16#4005)).

fd_cb_res_iy_test() ->
    %% RES 2,(IY-2): 0xFF -> 0xFB
    Machine0 = z80_emulator:init(),
    Mem0 = Machine0#machine_state.memory,
    Mem1 = z80_mem:write_byte(Mem0, 16#4FFE, 16#FF),
    Mem2 = z80_mem:write_byte(Mem1, 0, 16#FD),
    Mem3 = z80_mem:write_byte(Mem2, 1, 16#CB),
    Mem4 = z80_mem:write_byte(Mem3, 2, 16#FE),
    Mem5 = z80_mem:write_byte(Mem4, 3, 16#96),
    Machine1 = Machine0#machine_state{memory = Mem5, cpu = Machine0#machine_state.cpu#cpu_state{iyh = 16#50, iyl = 16#00}},
    Machine2 = z80_cpu:step(Machine1),
    ?assertEqual(16#FB, z80_mem:read_byte(Machine2#machine_state.memory, 16#4FFE)).
...
dd_cb_set_0_ix_test() ->
    ...
    Machine0 = z80_emulator:init(),
    Mem0 = Machine0#machine_state.memory,
    Mem1 = z80_mem:write_byte(Mem0, 16#4000, 16#FE),
    Mem2 = z80_mem:write_byte(Mem1, 0, 16#DD),
    Mem3 = z80_mem:write_byte(Mem2, 1, 16#CB),
    Mem4 = z80_mem:write_byte(Mem3, 2, 16#00),
    Mem5 = z80_mem:write_byte(Mem4, 3, 16#C6),
    Machine1 = Machine0#machine_state{memory = Mem5, cpu = Machine0#machine_state.cpu#cpu_state{ixh = 16#40, ixl = 16#00}},
    Machine2 = z80_cpu:step(Machine1),
    ?assertEqual(16#FF, z80_mem:read_byte(Machine2#machine_state.memory, 16#4000)).
...
dd_cb_set_7_ix_test() ->
    ...
    Mem3 = z80_mem:write_byte(Mem2, 1, 16#CB),
    Mem4 = z80_mem:write_byte(Mem3, 2, 16#00),
    Mem5 = z80_mem:write_byte(Mem4, 3, 16#FE),
    Machine1 = Machine0#machine_state{memory = Mem5, cpu = Machine0#machine_state.cpu#cpu_state{ixh = 16#40, ixl = 16#00}},
    Machine2 = z80_cpu:step(Machine1),
    ?assertEqual(16#FF, z80_mem:read_byte(Machine2#machine_state.memory, 16#4000)).
...
dd_cb_set_2_ix_test() ->
    ...
    Machine0 = z80_emulator:init(),
    Mem0 = Machine0#machine_state.memory,
    Mem1 = z80_mem:write_byte(Mem0, 16#4003, 16#F3),
    Mem2 = z80_mem:write_byte(Mem1, 0, 16#DD),
    Mem3 = z80_mem:write_byte(Mem2, 1, 16#CB),
    Mem4 = z80_mem:write_byte(Mem3, 2, 16#03),
    Mem5 = z80_mem:write_byte(Mem4, 3, 16#D6),
    Machine1 = Machine0#machine_state{memory = Mem5, cpu = Machine0#machine_state.cpu#cpu_state{ixh = 16#40, ixl = 16#00}},
    Machine2 = z80_cpu:step(Machine1),
    ?assertEqual(16#F7, z80_mem:read_byte(Machine2#machine_state.memory, 16#4003)).

fd_cb_set_iy_test() ->
    %% SET 4,(IY+1): 0xEF -> 0xFF (0xE6 = SET 4, reg=6)
    Machine0 = z80_emulator:init(),
    Mem0 = Machine0#machine_state.memory,
    Mem1 = z80_mem:write_byte(Mem0, 16#5001, 16#EF),
    Mem2 = z80_mem:write_byte(Mem1, 0, 16#FD),
    Mem3 = z80_mem:write_byte(Mem2, 1, 16#CB),
    Mem4 = z80_mem:write_byte(Mem3, 2, 16#01),
    Mem5 = z80_mem:write_byte(Mem4, 3, 16#E6),
    Machine1 = Machine0#machine_state{memory = Mem5, cpu = Machine0#machine_state.cpu#cpu_state{iyh = 16#50, iyl = 16#00}},
    Machine2 = z80_cpu:step(Machine1),
    ?assertEqual(16#FF, z80_mem:read_byte(Machine2#machine_state.memory, 16#5001)).
...
dd_prefix_state_during_cb_test() ->
    Machine0 = z80_emulator:init(),
    Mem0 = Machine0#machine_state.memory,
    Mem1 = z80_mem:write_byte(Mem0, 16#4000, 16#00),
    Mem2 = z80_mem:write_byte(Mem1, 0, 16#DD),
    Mem3 = z80_mem:write_byte(Mem2, 1, 16#CB),
    Mem4 = z80_mem:write_byte(Mem3, 2, 16#00),
    Mem5 = z80_mem:write_byte(Mem4, 3, 16#06),
    Machine1 = Machine0#machine_state{memory = Mem5, cpu = Machine0#machine_state.cpu#cpu_state{ixh = 16#40, ixl = 16#00}},
    Machine2 = z80_cpu:step(Machine1),
    ?assertEqual(none, Machine2#machine_state.cpu#cpu_state.prefix).
...
fd_prefix_state_during_cb_test() ->
    Machine0 = z80_emulator:init(),
    Mem0 = Machine0#machine_state.memory,
    Mem1 = z80_mem:write_byte(Mem0, 16#5000, 16#00),
    Mem2 = z80_mem:write_byte(Mem1, 0, 16#FD),
    Mem3 = z80_mem:write_byte(Mem2, 1, 16#CB),
    Mem4 = z80_mem:write_byte(Mem3, 2, 16#00),
    Mem5 = z80_mem:write_byte(Mem4, 3, 16#06),
...
dd_cb_memory_writeback_test() ->
    ...
    Machine1 = Machine0#machine_state{memory = Mem5, cpu = Machine0#machine_state.cpu#cpu_state{ixh = 16#40, ixl = 16#00}},
    Machine2 = z80_cpu:step(Machine1),
    ?assertEqual(16#02, z80_mem:read_byte(Machine2#machine_state.memory, 16#4000)).
...
dd_cb_bit_no_memory_write_test() ->
    ...
    Machine1 = Machine0#machine_state{memory = Mem5, cpu = Machine0#machine_state.cpu#cpu_state{ixh = 16#40, ixl = 16#00}},
    Machine2 = z80_cpu:step(Machine1),
    ?assertEqual(16#55, z80_mem:read_byte(Machine2#machine_state.memory, 16#4000)).
...
dd_cb_rlc_b_reg_test() ->
    ...
    Machine0 = z80_emulator:init(),
    Mem0 = Machine0#machine_state.memory,
    Mem1 = z80_mem:write_byte(Mem0, 16#4000, 16#81),  %% value at (IX+0)
    Mem2 = z80_mem:write_byte(Mem1, 0, 16#DD),
    Mem3 = z80_mem:write_byte(Mem2, 1, 16#CB),
    Mem4 = z80_mem:write_byte(Mem3, 2, 16#00),      %% displacement 0
    Mem5 = z80_mem:write_byte(Mem4, 3, 16#00),      %% RLC (IX+0) -> copy to B
    ...
    ?assertEqual(?FLAG_C, Machine2#machine_state.cpu#cpu_state.f band ?FLAG_C),
    ?assertEqual(16#03, z80_mem:read_byte(Machine2#machine_state.memory, 16#4000)).  %% memory also updated
...
dd_cb_rlc_c_reg_test() ->
    ...
    Mem3 = z80_mem:write_byte(Mem2, 1, 16#CB),
    Mem4 = z80_mem:write_byte(Mem3, 2, 16#00),
    Mem5 = z80_mem:write_byte(Mem4, 3, 16#01),      %% RLC (IX+0) -> copy to C
...
dd_cb_rlc_a_reg_test() ->
    ...
    Machine0 = z80_emulator:init(),
    Mem0 = Machine0#machine_state.memory,
    Mem1 = z80_mem:write_byte(Mem0, 16#4000, 16#FF),  %% value at (IX+0)
    Mem2 = z80_mem:write_byte(Mem1, 0, 16#DD),
    Mem3 = z80_mem:write_byte(Mem2, 1, 16#CB),
    Mem4 = z80_mem:write_byte(Mem3, 2, 16#00),
    Mem5 = z80_mem:write_byte(Mem4, 3, 16#07),      %% RLC (IX+0) -> copy to A
...
dd_cb_bit_0_b_reg_test() ->
    ...
    Machine0 = z80_emulator:init(),
    Mem0 = Machine0#machine_state.memory,
    Mem1 = z80_mem:write_byte(Mem0, 16#4000, 16#01),  %% value at (IX+0), bit 0 = 1
    Mem2 = z80_mem:write_byte(Mem1, 0, 16#DD),
    Mem3 = z80_mem:write_byte(Mem2, 1, 16#CB),
    Mem4 = z80_mem:write_byte(Mem3, 2, 16#00),
    Mem5 = z80_mem:write_byte(Mem4, 3, 16#40),      %% BIT 0,(IX+0) - no register copy
    Machine1 = Machine0#machine_state{memory = Mem5, cpu = Machine0#machine_state.cpu#cpu_state{b = 16#00, ixh = 16#40, ixl = 16#00, f = 0}},
    Machine2 = z80_cpu:step(Machine1),
...
dd_cb_bit_7_a_reg_test() ->
    ...
    Machine0 = z80_emulator:init(),
    Mem0 = Machine0#machine_state.memory,
    Mem1 = z80_mem:write_byte(Mem0, 16#4000, 16#80),  %% value at (IX+0), bit 7 = 1
    Mem2 = z80_mem:write_byte(Mem1, 0, 16#DD),
    Mem3 = z80_mem:write_byte(Mem2, 1, 16#CB),
    Mem4 = z80_mem:write_byte(Mem3, 2, 16#00),
    Mem5 = z80_mem:write_byte(Mem4, 3, 16#7F),      %% BIT 7,(IX+0) - no register copy
    Machine1 = Machine0#machine_state{memory = Mem5, cpu = Machine0#machine_state.cpu#cpu_state{a = 16#00, ixh = 16#40, ixl = 16#00, f = 0}},
    Machine2 = z80_cpu:step(Machine1),
    ?assertEqual(0, Machine2#machine_state.cpu#cpu_state.f band ?FLAG_Z),
    ?assertEqual(?FLAG_S, Machine2#machine_state.cpu#cpu_state.f band ?FLAG_S),
...
dd_cb_res_3_d_reg_test() ->
    ...
    Mem3 = z80_mem:write_byte(Mem2, 1, 16#CB),
    Mem4 = z80_mem:write_byte(Mem3, 2, 16#00),
    Mem5 = z80_mem:write_byte(Mem4, 3, 16#9A),      %% RES 3,(IX+0) -> copy to D
    ...
    ?assertEqual(16#F7, z80_mem:read_byte(Machine2#machine_state.memory, 16#4000)).
...
dd_cb_set_5_e_reg_test() ->
    ...
    Mem3 = z80_mem:write_byte(Mem2, 1, 16#CB),
    Mem4 = z80_mem:write_byte(Mem3, 2, 16#00),
    Mem5 = z80_mem:write_byte(Mem4, 3, 16#EB),      %% SET 5,(IX+0) -> copy to E
...
dd_cb_rl_h_reg_test() ->
    ...
    Mem3 = z80_mem:write_byte(Mem2, 1, 16#CB),
    Mem4 = z80_mem:write_byte(Mem3, 2, 16#00),
    Mem5 = z80_mem:write_byte(Mem4, 3, 16#14),      %% RL (IX+0) -> copy to H
...
fd_cb_sla_l_reg_test() ->
    ...
    Machine0 = z80_emulator:init(),
    Mem0 = Machine0#machine_state.memory,
    Mem1 = z80_mem:write_byte(Mem0, 16#5000, 16#40),  %% value at (IY+0)
    Mem2 = z80_mem:write_byte(Mem1, 0, 16#FD),
    Mem3 = z80_mem:write_byte(Mem2, 1, 16#CB),
    Mem4 = z80_mem:write_byte(Mem3, 2, 16#00),
    Mem5 = z80_mem:write_byte(Mem4, 3, 16#25),      %% SLA (IY+0) -> copy to L
    ...
    ?assertEqual(?FLAG_S, Machine2#machine_state.cpu#cpu_state.f band ?FLAG_S),
    ?assertEqual(16#80, z80_mem:read_byte(Machine2#machine_state.memory, 16#5000)).
...
dd_cb_register_ops_read_write_memory_test() ->
    ...
    Machine0 = z80_emulator:init(),
    Mem0 = Machine0#machine_state.memory,
    Mem1 = z80_mem:write_byte(Mem0, 16#4000, 16#81),  %% value at (IX+0) = 0x81 (10000001)
    Mem2 = z80_mem:write_byte(Mem1, 0, 16#DD),
    Mem3 = z80_mem:write_byte(Mem2, 1, 16#CB),
    Mem4 = z80_mem:write_byte(Mem3, 2, 16#00),
    Mem5 = z80_mem:write_byte(Mem4, 3, 16#00),  %% RLC (IX+0) -> copy to B
    ...
    ?assertEqual(16#03, z80_mem:read_byte(Machine2#machine_state.memory, 16#4000)),
