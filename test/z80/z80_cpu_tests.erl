...
ld_bc_nn_test() ->
    Cpu0 = init_cpu(),
    Cpu1 = load_program(Cpu0, 0, [16#01, 16#34, 16#12]),  %% LD BC, #1234
...
r_register_prefix_cb_increments_twice_test() ->
    Cpu0 = init_cpu(),
    Cpu1 = load_program(Cpu0, 0, [16#CB, 16#00]),  %% RLC B
    Cpu2 = z80_cpu:step(Cpu1),
...
r_register_prefix_ed_increments_twice_test() ->
    Cpu0 = init_cpu(),
    Cpu1 = load_program(Cpu0, 0, [16#ED, 16#47]),  %% LD I, A
...
jr_timing_test() ->
    Cpu0 = init_cpu(),
    Cpu1 = load_program(Cpu0, 0, [16#18, 16#05]),  %% JR $+7
    Cpu2 = z80_cpu:step(Cpu1),
...
jr_nz_taken_timing_test() ->
    Cpu0 = init_cpu(),
    Cpu1 = load_program(Cpu0, 0, [16#20, 16#05]),  %% JR NZ, $+7
...
djnz_timing_test() ->
    Cpu0 = init_cpu(),
    Cpu1 = load_program(Cpu0, 0, [16#10, 16#FC]),  %% DJNZ $-2
...
jp_cc_timing_test() ->
    Cpu0 = init_cpu(),
    Cpu1 = load_program(Cpu0, 0, [16#C2, 16#00, 16#80]),  %% JP NZ, #8000
    Cpu2 = Cpu1#cpu_state{f = 0},
    Cpu3 = z80_cpu:step(Cpu2),
...
call_cc_timing_test() ->
    Cpu0 = init_cpu(),
    Cpu1 = load_program(Cpu0, 0, [16#C4, 16#00, 16#80]),  %% CALL NZ, #8000
...
ret_cc_timing_test() ->
    Cpu0 = init_cpu(),
    Cpu1 = load_program(Cpu0, 0, [16#C0]),                     %% RET NZ
    Cpu1a = load_program(Cpu1, 16#1000, [16#00, 16#80]),       %% return address #8000
...
add_hl_bc_timing_test() ->
    Cpu0 = init_cpu(),
    Cpu1 = load_program(Cpu0, 0, [16#09]),  %% ADD HL, BC
    Cpu2 = z80_cpu:step(Cpu1),
    ?assertEqual(11, z80_cpu:t_states(Cpu2)).

push_pop_timing_test() ->
    Cpu0 = init_cpu(),
    Cpu1 = load_program(Cpu0, 0, [16#C5, 16#C1]),  %% PUSH BC / POP BC
...
ex_af_af_timing_test() ->
    Cpu0 = init_cpu(),
    Cpu1 = load_program(Cpu0, 0, [16#08]),  %% EX AF, AF'
    Cpu2 = z80_cpu:step(Cpu1),
    ?assertEqual(4, z80_cpu:t_states(Cpu2)).

ex_de_hl_timing_test() ->
    Cpu0 = init_cpu(),
    Cpu1 = load_program(Cpu0, 0, [16#EB]),  %% EX DE, HL
    Cpu2 = z80_cpu:step(Cpu1),
    ?assertEqual(4, z80_cpu:t_states(Cpu2)).

ex_sp_hl_timing_test() ->
    Cpu0 = init_cpu(),
    Cpu1 = load_program(Cpu0, 0, [16#E3]),                     %% EX (SP), HL
    Cpu1a = load_program(Cpu1, 16#1000, [16#56, 16#78]),       %% stack data
...
in_out_timing_test() ->
    Cpu0 = init_cpu(),
    Cpu1 = load_program(Cpu0, 0, [16#DB, 16#FF]),  %% IN A, (#FF)
    Cpu2 = z80_cpu:step(Cpu1),
    ?assertEqual(11, z80_cpu:t_states(Cpu2)).

halt_timing_test() ->
    Cpu0 = init_cpu(),
    Cpu1 = load_program(Cpu0, 0, [16#76]),  %% HALT
    Cpu2 = z80_cpu:step(Cpu1),
    ?assertEqual(4, z80_cpu:t_states(Cpu2)),
...
di_ei_timing_test() ->
    Cpu0 = init_cpu(),
    Cpu1 = load_program(Cpu0, 0, [16#F3, 16#FB]),  %% DI / EI
    Cpu2 = z80_cpu:step(Cpu1),
    ?assertEqual(4, z80_cpu:t_states(Cpu2)),
...
daa_after_add_test() ->
    ...
    Cpu2 = load_program(Cpu1, 0, [16#C6, 16#27, 16#27]),  %% ADD A, #27 / DAA
    Cpu3 = z80_cpu:step(Cpu2),
    Cpu4 = z80_cpu:step(Cpu3),
...
daa_after_sub_test() ->
    ...
    Cpu2 = load_program(Cpu1, 0, [16#D6, 16#37, 16#27]),  %% SUB #37 / DAA
    Cpu3 = z80_cpu:step(Cpu2),
    Cpu4 = z80_cpu:step(Cpu3),
...
daa_carry_test() ->
    ...
    Cpu2 = load_program(Cpu1, 0, [16#C6, 16#01, 16#27]),  %% ADD A, #01 / DAA
    Cpu3 = z80_cpu:step(Cpu2),
    Cpu4 = z80_cpu:step(Cpu3),
