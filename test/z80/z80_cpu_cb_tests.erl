...
cb_rlc_b_timing_test() ->
    ...
    Mem1 = ezx_memory_48:cpu_write_byte(Mem0, 0, 16#CB),  %% CB prefix
...
cb_rlc_c_test() ->
    ...
    Mem0 = Machine0#machine_state.memory,
    Mem1 = ezx_memory_48:cpu_write_byte(Mem0, 0, 16#CB),  %% CB prefix
    Mem2 = ezx_memory_48:cpu_write_byte(Mem1, 1, 16#01),  %% RLC C
    Machine1 = Machine0#machine_state{memory = Mem2},
...
cb_rlc_d_test() ->
    ...
    Mem0 = Machine0#machine_state.memory,
    Mem1 = ezx_memory_48:cpu_write_byte(Mem0, 0, 16#CB),  %% CB prefix
    Mem2 = ezx_memory_48:cpu_write_byte(Mem1, 1, 16#02),  %% RLC D
    Machine1 = Machine0#machine_state{memory = Mem2},
...
cb_rlc_e_test() ->
    ...
    Mem0 = Machine0#machine_state.memory,
    Mem1 = ezx_memory_48:cpu_write_byte(Mem0, 0, 16#CB),  %% CB prefix
    Mem2 = ezx_memory_48:cpu_write_byte(Mem1, 1, 16#03),  %% RLC E
    Machine1 = Machine0#machine_state{memory = Mem2},
...
cb_rlc_h_test() ->
    ...
    Mem0 = Machine0#machine_state.memory,
    Mem1 = ezx_memory_48:cpu_write_byte(Mem0, 0, 16#CB),  %% CB prefix
    Mem2 = ezx_memory_48:cpu_write_byte(Mem1, 1, 16#04),  %% RLC H
    Machine1 = Machine0#machine_state{memory = Mem2},
...
cb_rlc_l_test() ->
    ...
    Mem0 = Machine0#machine_state.memory,
    Mem1 = ezx_memory_48:cpu_write_byte(Mem0, 0, 16#CB),  %% CB prefix
    Mem2 = ezx_memory_48:cpu_write_byte(Mem1, 1, 16#05),  %% RLC L
    Machine1 = Machine0#machine_state{memory = Mem2},
...
cb_rlc_a_test() ->
    ...
    Mem0 = Machine0#machine_state.memory,
    Mem1 = ezx_memory_48:cpu_write_byte(Mem0, 0, 16#CB),  %% CB prefix
    Mem2 = ezx_memory_48:cpu_write_byte(Mem1, 1, 16#07),  %% RLC A
    Machine1 = Machine0#machine_state{memory = Mem2},
...
cb_rlc_hl_test() ->
    ...
    Mem0 = Machine0#machine_state.memory,
    Mem1 = ezx_memory_48:cpu_write_byte(Mem0, 0, 16#CB),  %% CB prefix
    Mem2 = ezx_memory_48:cpu_write_byte(Mem1, 1, 16#06),  %% RLC (HL)
    Mem3 = ezx_memory_48:cpu_write_byte(Mem2, 16#4000, 16#80),  %% value at HL
...
cb_rlc_hl_zero_test() ->
    ...
    Mem2 = ezx_memory_48:cpu_write_byte(Mem1, 1, 16#06),
    Mem3 = ezx_memory_48:cpu_write_byte(Mem2, 16#4000, 16#00),  %% 0x00 -> 0x00, Z=1
    Machine1 = Machine0#machine_state{memory = Mem3, cpu = Machine0#machine_state.cpu#cpu_state{h = 16#40, l = 16#00}},
    Machine2 = z80_cpu:step(Machine1),
...
cb_rrc_b_test() ->
    ...
    Mem0 = Machine0#machine_state.memory,
    Mem1 = ezx_memory_48:cpu_write_byte(Mem0, 0, 16#CB),  %% CB prefix
    Mem2 = ezx_memory_48:cpu_write_byte(Mem1, 1, 16#08),  %% RRC B
    Machine1 = Machine0#machine_state{memory = Mem2},
...
cb_rrc_c_test() ->
    ...
    Mem0 = Machine0#machine_state.memory,
    Mem1 = ezx_memory_48:cpu_write_byte(Mem0, 0, 16#CB),  %% CB prefix
    Mem2 = ezx_memory_48:cpu_write_byte(Mem1, 1, 16#09),  %% RRC C
    Machine1 = Machine0#machine_state{memory = Mem2},
...
cb_rrc_a_test() ->
    ...
    Mem0 = Machine0#machine_state.memory,
    Mem1 = ezx_memory_48:cpu_write_byte(Mem0, 0, 16#CB),  %% CB prefix
    Mem2 = ezx_memory_48:cpu_write_byte(Mem1, 1, 16#0F),  %% RRC A
    Machine1 = Machine0#machine_state{memory = Mem2},
...
cb_rrc_hl_test() ->
    ...
    Mem0 = Machine0#machine_state.memory,
    Mem1 = ezx_memory_48:cpu_write_byte(Mem0, 0, 16#CB),  %% CB prefix
    Mem2 = ezx_memory_48:cpu_write_byte(Mem1, 1, 16#0E),  %% RRC (HL)
    Mem3 = ezx_memory_48:cpu_write_byte(Mem2, 16#4000, 16#01),  %% Memory at HL = 0x01
    Machine1 = Machine0#machine_state{memory = Mem3, cpu = Machine0#machine_state.cpu#cpu_state{h = 16#40, l = 16#00}},
    Machine2 = z80_cpu:step(Machine1),
...
cb_rl_b_test() ->
    ...
    Mem0 = Machine0#machine_state.memory,
    Mem1 = ezx_memory_48:cpu_write_byte(Mem0, 0, 16#CB),  %% CB prefix
    Mem2 = ezx_memory_48:cpu_write_byte(Mem1, 1, 16#10),  %% RL B
    Machine1 = Machine0#machine_state{memory = Mem2},
    Cpu1 = Machine1#machine_state.cpu#cpu_state{b = 16#81, f = 0},
    Machine2 = Machine1#machine_state{cpu = Cpu1},
    Machine3 = z80_cpu:step(Machine2),
...
cb_rl_c_test() ->
    ...
    Mem0 = Machine0#machine_state.memory,
    Mem1 = ezx_memory_48:cpu_write_byte(Mem0, 0, 16#CB),  %% CB prefix
    Mem2 = ezx_memory_48:cpu_write_byte(Mem1, 1, 16#11),  %% RL C
    Machine1 = Machine0#machine_state{memory = Mem2},
...
cb_rl_a_test() ->
    ...
    Mem0 = Machine0#machine_state.memory,
    Mem1 = ezx_memory_48:cpu_write_byte(Mem0, 0, 16#CB),  %% CB prefix
    Mem2 = ezx_memory_48:cpu_write_byte(Mem1, 1, 16#17),  %% RL A
    Machine1 = Machine0#machine_state{memory = Mem2},
...
cb_rl_hl_test() ->
    ...
    Mem0 = Machine0#machine_state.memory,
    Mem1 = ezx_memory_48:cpu_write_byte(Mem0, 0, 16#CB),
    Mem2 = ezx_memory_48:cpu_write_byte(Mem1, 1, 16#16),  %% RL (HL)
    Mem3 = ezx_memory_48:cpu_write_byte(Mem2, 16#4000, 16#7F),  %% 01111111
...
cb_rl_hl_no_carry_test() ->
    ...
    Mem0 = Machine0#machine_state.memory,
    Mem1 = ezx_memory_48:cpu_write_byte(Mem0, 0, 16#CB),
    Mem2 = ezx_memory_48:cpu_write_byte(Mem1, 1, 16#16),
    Mem3 = ezx_memory_48:cpu_write_byte(Mem2, 16#4000, 16#7F),  %% 01111111
...
cb_rr_b_test() ->
    ...
    Mem0 = Machine0#machine_state.memory,
    Mem1 = ezx_memory_48:cpu_write_byte(Mem0, 0, 16#CB),  %% CB prefix
    Mem2 = ezx_memory_48:cpu_write_byte(Mem1, 1, 16#18),  %% RR B
    Machine1 = Machine0#machine_state{memory = Mem2},
    Cpu1 = Machine1#machine_state.cpu#cpu_state{b = 16#01, f = 0},
    Machine2 = Machine1#machine_state{cpu = Cpu1},
    Machine3 = z80_cpu:step(Machine2),
...
cb_rr_c_test() ->
    ...
    Mem0 = Machine0#machine_state.memory,
    Mem1 = ezx_memory_48:cpu_write_byte(Mem0, 0, 16#CB),  %% CB prefix
    Mem2 = ezx_memory_48:cpu_write_byte(Mem1, 1, 16#19),  %% RR C
    Machine1 = Machine0#machine_state{memory = Mem2},
...
cb_rr_a_test() ->
    ...
    Mem0 = Machine0#machine_state.memory,
    Mem1 = ezx_memory_48:cpu_write_byte(Mem0, 0, 16#CB),  %% CB prefix
    Mem2 = ezx_memory_48:cpu_write_byte(Mem1, 1, 16#1F),  %% RR A
    Machine1 = Machine0#machine_state{memory = Mem2},
...
cb_rr_hl_test() ->
    ...
    Mem0 = Machine0#machine_state.memory,
    Mem1 = ezx_memory_48:cpu_write_byte(Mem0, 0, 16#CB),
    Mem2 = ezx_memory_48:cpu_write_byte(Mem1, 1, 16#1E),  %% RR (HL)
    Mem3 = ezx_memory_48:cpu_write_byte(Mem2, 16#4000, 16#02),  %% 00000010
    Machine1 = Machine0#machine_state{memory = Mem3, cpu = Machine0#machine_state.cpu#cpu_state{h = 16#40, l = 16#00, f = 16#01}},  %% carry=1
    Machine2 = z80_cpu:step(Machine1),
...
cb_rr_hl_no_carry_test() ->
    ...
    Mem0 = Machine0#machine_state.memory,
    Mem1 = ezx_memory_48:cpu_write_byte(Mem0, 0, 16#CB),
    Mem2 = ezx_memory_48:cpu_write_byte(Mem1, 1, 16#1E),
    Mem3 = ezx_memory_48:cpu_write_byte(Mem2, 16#4000, 16#80),  %% 10000000
    Machine1 = Machine0#machine_state{memory = Mem3, cpu = Machine0#machine_state.cpu#cpu_state{h = 16#40, l = 16#00, f = 0}},  %% carry=0
    Machine2 = z80_cpu:step(Machine1),
...
cb_sla_b_test() ->
    ...
    Mem0 = Machine0#machine_state.memory,
    Mem1 = ezx_memory_48:cpu_write_byte(Mem0, 0, 16#CB),  %% CB prefix
    Mem2 = ezx_memory_48:cpu_write_byte(Mem1, 1, 16#20),  %% SLA B
    Machine1 = Machine0#machine_state{memory = Mem2},
...
cb_sla_c_test() ->
    ...
    Mem0 = Machine0#machine_state.memory,
    Mem1 = ezx_memory_48:cpu_write_byte(Mem0, 0, 16#CB),  %% CB prefix
    Mem2 = ezx_memory_48:cpu_write_byte(Mem1, 1, 16#21),  %% SLA C
    Machine1 = Machine0#machine_state{memory = Mem2},
...
cb_sla_d_test() ->
    ...
    Mem0 = Machine0#machine_state.memory,
    Mem1 = ezx_memory_48:cpu_write_byte(Mem0, 0, 16#CB),  %% CB prefix
    Mem2 = ezx_memory_48:cpu_write_byte(Mem1, 1, 16#22),  %% SLA D
    Machine1 = Machine0#machine_state{memory = Mem2},
...
cb_sla_a_test() ->
    ...
    Mem0 = Machine0#machine_state.memory,
    Mem1 = ezx_memory_48:cpu_write_byte(Mem0, 0, 16#CB),  %% CB prefix
    Mem2 = ezx_memory_48:cpu_write_byte(Mem1, 1, 16#27),  %% SLA A
    Machine1 = Machine0#machine_state{memory = Mem2},
    Cpu1 = Machine1#machine_state.cpu#cpu_state{a = 16#FF, f = 0},
    Machine2 = Machine1#machine_state{cpu = Cpu1},
    Machine3 = z80_cpu:step(Machine2),
...
cb_sla_hl_test() ->
    ...
    Mem0 = Machine0#machine_state.memory,
    Mem1 = ezx_memory_48:cpu_write_byte(Mem0, 0, 16#CB),  %% CB prefix
    Mem2 = ezx_memory_48:cpu_write_byte(Mem1, 1, 16#26),  %% SLA (HL)
    Mem3 = ezx_memory_48:cpu_write_byte(Mem2, 16#4000, 16#40),  %% 01000000 -> 10000000, carry=0
    Machine1 = Machine0#machine_state{memory = Mem3, cpu = Machine0#machine_state.cpu#cpu_state{h = 16#40, l = 16#00}},
    Machine2 = z80_cpu:step(Machine1),
...
cb_sla_hl_carry_test() ->
    ...
    Mem0 = Machine0#machine_state.memory,
    Mem1 = ezx_memory_48:cpu_write_byte(Mem0, 0, 16#CB),
    Mem2 = ezx_memory_48:cpu_write_byte(Mem1, 1, 16#26),
    Mem3 = ezx_memory_48:cpu_write_byte(Mem2, 16#4000, 16#80),  %% 10000000 -> 00000000, carry=1
    Machine1 = Machine0#machine_state{memory = Mem3, cpu = Machine0#machine_state.cpu#cpu_state{h = 16#40, l = 16#00}},
    Machine2 = z80_cpu:step(Machine1),
    ?assertEqual(16#00, ezx_emulator:read_byte(Machine2, 16#4000)),
    ?assertEqual(?FLAG_C, Machine2#machine_state.cpu#cpu_state.f band ?FLAG_C),
...
cb_sra_b_test() ->
    ...
    Mem0 = Machine0#machine_state.memory,
    Mem1 = ezx_memory_48:cpu_write_byte(Mem0, 0, 16#CB),  %% CB prefix
    Mem2 = ezx_memory_48:cpu_write_byte(Mem1, 1, 16#28),  %% SRA B
    Machine1 = Machine0#machine_state{memory = Mem2},
    Cpu1 = Machine1#machine_state.cpu#cpu_state{b = 16#81, f = 0},
    Machine2 = Machine1#machine_state{cpu = Cpu1},
    Machine3 = z80_cpu:step(Machine2),
...
cb_sra_c_test() ->
    ...
    Mem0 = Machine0#machine_state.memory,
    Mem1 = ezx_memory_48:cpu_write_byte(Mem0, 0, 16#CB),  %% CB prefix
    Mem2 = ezx_memory_48:cpu_write_byte(Mem1, 1, 16#29),  %% SRA C
    Machine1 = Machine0#machine_state{memory = Mem2},
...
cb_sra_a_test() ->
    ...
    Mem0 = Machine0#machine_state.memory,
    Mem1 = ezx_memory_48:cpu_write_byte(Mem0, 0, 16#CB),  %% CB prefix
    Mem2 = ezx_memory_48:cpu_write_byte(Mem1, 1, 16#2F),  %% SRA A
    Machine1 = Machine0#machine_state{memory = Mem2},
    Cpu1 = Machine1#machine_state.cpu#cpu_state{a = 16#02, f = 0},
    Machine2 = Machine1#machine_state{cpu = Cpu1},
    Machine3 = z80_cpu:step(Machine2),
...
cb_sra_hl_test() ->
    ...
    Mem0 = Machine0#machine_state.memory,
    Mem1 = ezx_memory_48:cpu_write_byte(Mem0, 0, 16#CB),  %% CB prefix
    Mem2 = ezx_memory_48:cpu_write_byte(Mem1, 1, 16#2E),  %% SRA (HL)
    Mem3 = ezx_memory_48:cpu_write_byte(Mem2, 16#4000, 16#80),  %% 10000000 -> 11000000 (preserve sign)
    Machine1 = Machine0#machine_state{memory = Mem3, cpu = Machine0#machine_state.cpu#cpu_state{h = 16#40, l = 16#00}},
    Machine2 = z80_cpu:step(Machine1),
...
cb_sra_hl_positive_test() ->
    ...
    Mem0 = Machine0#machine_state.memory,
    Mem1 = ezx_memory_48:cpu_write_byte(Mem0, 0, 16#CB),
    Mem2 = ezx_memory_48:cpu_write_byte(Mem1, 1, 16#2E),
    Mem3 = ezx_memory_48:cpu_write_byte(Mem2, 16#4000, 16#40),  %% 01000000 -> 00100000
    Machine1 = Machine0#machine_state{memory = Mem3, cpu = Machine0#machine_state.cpu#cpu_state{h = 16#40, l = 16#00}},
    Machine2 = z80_cpu:step(Machine1),
...
cb_sra_hl_carry_test() ->
    ...
    Mem1 = ezx_memory_48:cpu_write_byte(Mem0, 0, 16#CB),
    Mem2 = ezx_memory_48:cpu_write_byte(Mem1, 1, 16#2E),
    Mem3 = ezx_memory_48:cpu_write_byte(Mem2, 16#4000, 16#01),  %% 00000001 -> 00000000, carry=1
    Machine1 = Machine0#machine_state{memory = Mem3, cpu = Machine0#machine_state.cpu#cpu_state{h = 16#40, l = 16#00}},
    Machine2 = z80_cpu:step(Machine1),
    ?assertEqual(16#00, ezx_emulator:read_byte(Machine2, 16#4000)),
    ?assertEqual(?FLAG_C, Machine2#machine_state.cpu#cpu_state.f band ?FLAG_C),
...
cb_sll_b_test() ->
    ...
    Mem0 = Machine0#machine_state.memory,
    Mem1 = ezx_memory_48:cpu_write_byte(Mem0, 0, 16#CB),  %% CB prefix
    Mem2 = ezx_memory_48:cpu_write_byte(Mem1, 1, 16#30),  %% SLL B (undocumented)
    Machine1 = Machine0#machine_state{memory = Mem2},
    Cpu1 = Machine1#machine_state.cpu#cpu_state{b = 16#80, f = 0},
    Machine2 = Machine1#machine_state{cpu = Cpu1},
    Machine3 = z80_cpu:step(Machine2),
...
cb_sll_c_test() ->
    ...
    Mem0 = Machine0#machine_state.memory,
    Mem1 = ezx_memory_48:cpu_write_byte(Mem0, 0, 16#CB),  %% CB prefix
    Mem2 = ezx_memory_48:cpu_write_byte(Mem1, 1, 16#31),  %% SLL C
    Machine1 = Machine0#machine_state{memory = Mem2},
    Cpu1 = Machine1#machine_state.cpu#cpu_state{c = 16#40, f = 0},
    Machine2 = Machine1#machine_state{cpu = Cpu1},
    Machine3 = z80_cpu:step(Machine2),
...
cb_sll_a_test() ->
    ...
    Mem0 = Machine0#machine_state.memory,
    Mem1 = ezx_memory_48:cpu_write_byte(Mem0, 0, 16#CB),  %% CB prefix
    Mem2 = ezx_memory_48:cpu_write_byte(Mem1, 1, 16#37),  %% SLL A
    Machine1 = Machine0#machine_state{memory = Mem2},
...
cb_sll_hl_test() ->
    ...
    Mem0 = Machine0#machine_state.memory,
    Mem1 = ezx_memory_48:cpu_write_byte(Mem0, 0, 16#CB),  %% CB prefix
    Mem2 = ezx_memory_48:cpu_write_byte(Mem1, 1, 16#36),  %% SLL (HL)
    Mem3 = ezx_memory_48:cpu_write_byte(Mem2, 16#4000, 16#40),  %% 01000000 -> 10000001
    Machine1 = Machine0#machine_state{memory = Mem3, cpu = Machine0#machine_state.cpu#cpu_state{h = 16#40, l = 16#00}},
    Machine2 = z80_cpu:step(Machine1),
...
cb_sll_hl_carry_test() ->
    ...
    Mem0 = Machine0#machine_state.memory,
    Mem1 = ezx_memory_48:cpu_write_byte(Mem0, 0, 16#CB),
    Mem2 = ezx_memory_48:cpu_write_byte(Mem1, 1, 16#36),
    Mem3 = ezx_memory_48:cpu_write_byte(Mem2, 16#4000, 16#80),  %% 10000000 -> 00000001, carry=1
    Machine1 = Machine0#machine_state{memory = Mem3, cpu = Machine0#machine_state.cpu#cpu_state{h = 16#40, l = 16#00}},
    Machine2 = z80_cpu:step(Machine1),
...
cb_srl_b_test() ->
    ...
    Mem0 = Machine0#machine_state.memory,
    Mem1 = ezx_memory_48:cpu_write_byte(Mem0, 0, 16#CB),  %% CB prefix
    Mem2 = ezx_memory_48:cpu_write_byte(Mem1, 1, 16#38),  %% SRL B
    Machine1 = Machine0#machine_state{memory = Mem2},
    Cpu1 = Machine1#machine_state.cpu#cpu_state{b = 16#81, f = 0},
    Machine2 = Machine1#machine_state{cpu = Cpu1},
    Machine3 = z80_cpu:step(Machine2),
...
cb_srl_c_test() ->
    ...
    Mem0 = Machine0#machine_state.memory,
    Mem1 = ezx_memory_48:cpu_write_byte(Mem0, 0, 16#CB),  %% CB prefix
    Mem2 = ezx_memory_48:cpu_write_byte(Mem1, 1, 16#39),  %% SRL C
    Machine1 = Machine0#machine_state{memory = Mem2},
    Cpu1 = Machine1#machine_state.cpu#cpu_state{c = 16#02, f = 0},
    Machine2 = Machine1#machine_state{cpu = Cpu1},
    Machine3 = z80_cpu:step(Machine2),
...
cb_srl_d_test() ->
    ...
    Mem0 = Machine0#machine_state.memory,
    Mem1 = ezx_memory_48:cpu_write_byte(Mem0, 0, 16#CB),  %% CB prefix
    Mem2 = ezx_memory_48:cpu_write_byte(Mem1, 1, 16#3A),  %% SRL D
    Machine1 = Machine0#machine_state{memory = Mem2},
    Cpu1 = Machine1#machine_state.cpu#cpu_state{d = 16#FF, f = 0},
    Machine2 = Machine1#machine_state{cpu = Cpu1},
    Machine3 = z80_cpu:step(Machine2),
...
cb_srl_a_test() ->
    ...
    Mem0 = Machine0#machine_state.memory,
    Mem1 = ezx_memory_48:cpu_write_byte(Mem0, 0, 16#CB),  %% CB prefix
    Mem2 = ezx_memory_48:cpu_write_byte(Mem1, 1, 16#3F),  %% SRL A
    Machine1 = Machine0#machine_state{memory = Mem2},
...
cb_srl_hl_test() ->
    ...
    Mem0 = Machine0#machine_state.memory,
    Mem1 = ezx_memory_48:cpu_write_byte(Mem0, 0, 16#CB),  %% CB prefix
    Mem2 = ezx_memory_48:cpu_write_byte(Mem1, 1, 16#3E),  %% SRL (HL)
    Mem3 = ezx_memory_48:cpu_write_byte(Mem2, 16#4000, 16#81),  %% 10000001 -> 01000000
    Machine1 = Machine0#machine_state{memory = Mem3, cpu = Machine0#machine_state.cpu#cpu_state{h = 16#40, l = 16#00}},
    Machine2 = z80_cpu:step(Machine1),
...
cb_srl_hl_carry_test() ->
    ...
    Mem0 = Machine0#machine_state.memory,
    Mem1 = ezx_memory_48:cpu_write_byte(Mem0, 0, 16#CB),
    Mem2 = ezx_memory_48:cpu_write_byte(Mem1, 1, 16#3E),
    Mem3 = ezx_memory_48:cpu_write_byte(Mem2, 16#4000, 16#01),  %% 00000001 -> 00000000
    Machine1 = Machine0#machine_state{memory = Mem3, cpu = Machine0#machine_state.cpu#cpu_state{h = 16#40, l = 16#00}},
    Machine2 = z80_cpu:step(Machine1),
    ?assertEqual(16#00, ezx_emulator:read_byte(Machine2, 16#4000)),
    ?assertEqual(?FLAG_C, Machine2#machine_state.cpu#cpu_state.f band ?FLAG_C),
...
cb_bit_test() ->
    ...
    Mem0 = Machine0#machine_state.memory,
    Mem1 = ezx_memory_48:cpu_write_byte(Mem0, 0, 16#CB),  %% CB prefix
    Mem2 = ezx_memory_48:cpu_write_byte(Mem1, 1, 16#40),  %% BIT 0,B
    Machine1 = Machine0#machine_state{memory = Mem2},
...
cb_bit_1_b_test() ->
    ...
    Mem0 = Machine0#machine_state.memory,
    Mem1 = ezx_memory_48:cpu_write_byte(Mem0, 0, 16#CB),  %% CB prefix
    Mem2 = ezx_memory_48:cpu_write_byte(Mem1, 1, 16#48),  %% BIT 1,B
    Machine1 = Machine0#machine_state{memory = Mem2},
...
cb_bit_7_b_test() ->
    ...
    Mem0 = Machine0#machine_state.memory,
    Mem1 = ezx_memory_48:cpu_write_byte(Mem0, 0, 16#CB),  %% CB prefix
    Mem2 = ezx_memory_48:cpu_write_byte(Mem1, 1, 16#78),  %% BIT 7,B
    Machine1 = Machine0#machine_state{memory = Mem2},
...
cb_bit_0_c_test() ->
    ...
    Mem0 = Machine0#machine_state.memory,
    Mem1 = ezx_memory_48:cpu_write_byte(Mem0, 0, 16#CB),  %% CB prefix
    Mem2 = ezx_memory_48:cpu_write_byte(Mem1, 1, 16#41),  %% BIT 0,C
    Machine1 = Machine0#machine_state{memory = Mem2},
...
cb_bit_3_d_test() ->
    ...
    Mem0 = Machine0#machine_state.memory,
    Mem1 = ezx_memory_48:cpu_write_byte(Mem0, 0, 16#CB),  %% CB prefix
    Mem2 = ezx_memory_48:cpu_write_byte(Mem1, 1, 16#5A),  %% BIT 3,D
    Machine1 = Machine0#machine_state{memory = Mem2},
...
cb_bit_hl_test() ->
    ...
    Mem0 = Machine0#machine_state.memory,
    Mem1 = ezx_memory_48:cpu_write_byte(Mem0, 0, 16#CB),  %% CB prefix
    Mem2 = ezx_memory_48:cpu_write_byte(Mem1, 1, 16#46),  %% BIT 0,(HL)
    Mem3 = ezx_memory_48:cpu_write_byte(Mem2, 16#4000, 16#01),
...
cb_bit_5_hl_test() ->
    ...
    Mem0 = Machine0#machine_state.memory,
    Mem1 = ezx_memory_48:cpu_write_byte(Mem0, 0, 16#CB),  %% CB prefix
    Mem2 = ezx_memory_48:cpu_write_byte(Mem1, 1, 16#6E),  %% BIT 5,(HL)
    Mem3 = ezx_memory_48:cpu_write_byte(Mem2, 16#4000, 16#20),
    Machine1 = Machine0#machine_state{memory = Mem3},
    Cpu1 = Machine1#machine_state.cpu#cpu_state{h = 16#40, l = 16#00},
    Machine2 = Machine1#machine_state{cpu = Cpu1},
    Machine3 = z80_cpu:step(Machine2),
...
cb_bit_7_a_test() ->
    ...
    Mem0 = Machine0#machine_state.memory,
    Mem1 = ezx_memory_48:cpu_write_byte(Mem0, 0, 16#CB),  %% CB prefix
    Mem2 = ezx_memory_48:cpu_write_byte(Mem1, 1, 16#7F),  %% BIT 7,A
    Machine1 = Machine0#machine_state{memory = Mem2},
...
cb_res_test() ->
    ...
    Mem0 = Machine0#machine_state.memory,
    Mem1 = ezx_memory_48:cpu_write_byte(Mem0, 0, 16#CB),  %% CB prefix
    Mem2 = ezx_memory_48:cpu_write_byte(Mem1, 1, 16#80),  %% RES 0,B
    Machine1 = Machine0#machine_state{memory = Mem2},
...
cb_res_1_b_test() ->
    ...
    Mem0 = Machine0#machine_state.memory,
    Mem1 = ezx_memory_48:cpu_write_byte(Mem0, 0, 16#CB),  %% CB prefix
    Mem2 = ezx_memory_48:cpu_write_byte(Mem1, 1, 16#88),  %% RES 1,B
    Machine1 = Machine0#machine_state{memory = Mem2},
...
cb_res_7_b_test() ->
    ...
    Mem0 = Machine0#machine_state.memory,
    Mem1 = ezx_memory_48:cpu_write_byte(Mem0, 0, 16#CB),  %% CB prefix
    Mem2 = ezx_memory_48:cpu_write_byte(Mem1, 1, 16#B8),  %% RES 7,B
    Machine1 = Machine0#machine_state{memory = Mem2},
...
cb_res_0_c_test() ->
    ...
    Mem0 = Machine0#machine_state.memory,
    Mem1 = ezx_memory_48:cpu_write_byte(Mem0, 0, 16#CB),  %% CB prefix
    Mem2 = ezx_memory_48:cpu_write_byte(Mem1, 1, 16#81),  %% RES 0,C
    Machine1 = Machine0#machine_state{memory = Mem2},
...
cb_res_3_e_test() ->
    ...
    Mem0 = Machine0#machine_state.memory,
    Mem1 = ezx_memory_48:cpu_write_byte(Mem0, 0, 16#CB),  %% CB prefix
    Mem2 = ezx_memory_48:cpu_write_byte(Mem1, 1, 16#9B),  %% RES 3,E
    Machine1 = Machine0#machine_state{memory = Mem2},
...
cb_res_7_a_test() ->
    ...
    Mem0 = Machine0#machine_state.memory,
    Mem1 = ezx_memory_48:cpu_write_byte(Mem0, 0, 16#CB),  %% CB prefix
    Mem2 = ezx_memory_48:cpu_write_byte(Mem1, 1, 16#BF),  %% RES 7,A
    Machine1 = Machine0#machine_state{memory = Mem2},
...
cb_set_test() ->
    ...
    Mem0 = Machine0#machine_state.memory,
    Mem1 = ezx_memory_48:cpu_write_byte(Mem0, 0, 16#CB),  %% CB prefix
    Mem2 = ezx_memory_48:cpu_write_byte(Mem1, 1, 16#C0),  %% SET 0,B
    Machine1 = Machine0#machine_state{memory = Mem2},
    Cpu1 = Machine1#machine_state.cpu#cpu_state{b = 16#02},
    Machine2 = Machine1#machine_state{cpu = Cpu1},
    Machine3 = z80_cpu:step(Machine2),
...
cb_set_1_b_test() ->
    ...
    Mem0 = Machine0#machine_state.memory,
    Mem1 = ezx_memory_48:cpu_write_byte(Mem0, 0, 16#CB),  %% CB prefix
    Mem2 = ezx_memory_48:cpu_write_byte(Mem1, 1, 16#C8),  %% SET 1,B
    Machine1 = Machine0#machine_state{memory = Mem2},
    Cpu1 = Machine1#machine_state.cpu#cpu_state{b = 16#01},
    Machine2 = Machine1#machine_state{cpu = Cpu1},
    Machine3 = z80_cpu:step(Machine2),
...
cb_set_7_b_test() ->
    ...
    Mem0 = Machine0#machine_state.memory,
    Mem1 = ezx_memory_48:cpu_write_byte(Mem0, 0, 16#CB),  %% CB prefix
    Mem2 = ezx_memory_48:cpu_write_byte(Mem1, 1, 16#F8),  %% SET 7,B
    Machine1 = Machine0#machine_state{memory = Mem2},
    Cpu1 = Machine1#machine_state.cpu#cpu_state{b = 16#00},
    Machine2 = Machine1#machine_state{cpu = Cpu1},
    Machine3 = z80_cpu:step(Machine2),
...
cb_set_0_c_test() ->
    ...
    Mem0 = Machine0#machine_state.memory,
    Mem1 = ezx_memory_48:cpu_write_byte(Mem0, 0, 16#CB),  %% CB prefix
    Mem2 = ezx_memory_48:cpu_write_byte(Mem1, 1, 16#C1),  %% SET 0,C
    Machine1 = Machine0#machine_state{memory = Mem2},
...
cb_set_5_d_test() ->
    ...
    Mem0 = Machine0#machine_state.memory,
    Mem1 = ezx_memory_48:cpu_write_byte(Mem0, 0, 16#CB),  %% CB prefix
    Mem2 = ezx_memory_48:cpu_write_byte(Mem1, 1, 16#EA),  %% SET 5,D
    Machine1 = Machine0#machine_state{memory = Mem2},
...
cb_set_7_a_test() ->
    ...
    Mem0 = Machine0#machine_state.memory,
    Mem1 = ezx_memory_48:cpu_write_byte(Mem0, 0, 16#CB),  %% CB prefix
    Mem2 = ezx_memory_48:cpu_write_byte(Mem1, 1, 16#FF),  %% SET 7,A
    Machine1 = Machine0#machine_state{memory = Mem2},
