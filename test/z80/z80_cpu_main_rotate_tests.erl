...
rlca_test() ->
    ...
    Mem1 = z80_mem:write_byte(Mem0, 0, 16#07),  %% RLCA
...
rrca_test() ->
    ...
    Mem0 = Machine0#machine_state.memory,
    Mem1 = z80_mem:write_byte(Mem0, 0, 16#0F),  %% RRCA
    Machine1 = Machine0#machine_state{cpu = Cpu0, memory = Mem1},
    Machine2 = z80_cpu:step(Machine1),
    ?assertEqual(16#80, Machine2#machine_state.cpu#cpu_state.a),
    ?assertEqual(?FLAG_C, Machine2#machine_state.cpu#cpu_state.f band ?FLAG_C).
...
rla_test() ->
    ...
    Mem0 = Machine0#machine_state.memory,
    Mem1 = z80_mem:write_byte(Mem0, 0, 16#17),  %% RLA
    Machine1 = Machine0#machine_state{cpu = Cpu0, memory = Mem1},
    Machine2 = z80_cpu:step(Machine1),
    ?assertEqual(16#01, Machine2#machine_state.cpu#cpu_state.a),
    ?assertEqual(?FLAG_C, Machine2#machine_state.cpu#cpu_state.f band ?FLAG_C).
...
rra_test() ->
    ...
    Mem0 = Machine0#machine_state.memory,
    Mem1 = z80_mem:write_byte(Mem0, 0, 16#1F),  %% RRA
    Machine1 = Machine0#machine_state{cpu = Cpu0, memory = Mem1},
    Machine2 = z80_cpu:step(Machine1),
    ?assertEqual(16#80, Machine2#machine_state.cpu#cpu_state.a),
    ?assertEqual(?FLAG_C, Machine2#machine_state.cpu#cpu_state.f band ?FLAG_C).
...
cpl_test() ->
    ...
    Mem0 = Machine0#machine_state.memory,
    Mem1 = z80_mem:write_byte(Mem0, 0, 16#2F),  %% CPL
    Machine1 = Machine0#machine_state{cpu = Cpu0, memory = Mem1},
    Machine2 = z80_cpu:step(Machine1),
...
scf_test() ->
    ...
    Mem0 = Machine0#machine_state.memory,
    Mem1 = z80_mem:write_byte(Mem0, 0, 16#37),  %% SCF
    Machine1 = Machine0#machine_state{cpu = Cpu0, memory = Mem1},
    Machine2 = z80_cpu:step(Machine1),
    ?assertEqual(?FLAG_C, Machine2#machine_state.cpu#cpu_state.f band ?FLAG_C),
...
ccf_test() ->
    ...
    Cpu0 = Machine0#machine_state.cpu#cpu_state{f = 0},
    Mem0 = Machine0#machine_state.memory,
    Mem1 = z80_mem:write_byte(Mem0, 0, 16#3F),  %% CCF
    Machine1 = Machine0#machine_state{cpu = Cpu0, memory = Mem1},
    Machine2 = z80_cpu:step(Machine1),
    ?assertEqual(?FLAG_C, Machine2#machine_state.cpu#cpu_state.f band ?FLAG_C).
...
daa_after_add_test() ->
    ...
    Machine2 = z80_emulator:write_byte(Machine1, 0, 16#C6),  %% ADD A,n
    Machine3 = z80_emulator:write_byte(Machine2, 1, 16#27),
    Machine4 = z80_emulator:write_byte(Machine3, 2, 16#27),  %% DAA
...
daa_after_sub_test() ->
    ...
    Machine1 = Machine0#machine_state{cpu = Cpu0},
    Machine2 = z80_emulator:write_byte(Machine1, 0, 16#D6),  %% SUB n
