...
rst_00_test() ->
    ...
    ?assertEqual(16#01, test_helpers:read_mem(Cpu3, 16#0FFE)),  %% Low byte of pushed PC=1
    ?assertEqual(16#00, test_helpers:read_mem(Cpu3, 16#0FFF)).  %% High byte of pushed PC=1
