...
ret_test() ->
    ...
    Mem1 = z80_mem:write_byte(Mem0, 0, 16#C9),  %% RET
...
ret_nz_taken_test() ->
    Machine0 = z80_emulator:init(),
    Mem0 = Machine0#machine_state.memory,
    Mem1 = z80_mem:write_byte(Mem0, 0, 16#C0),  %% RET NZ
    Mem2 = z80_mem:write_byte(Mem1, 16#1000, 16#00),
    Mem3 = z80_mem:write_byte(Mem2, 16#1001, 16#80),
...
ret_z_taken_test() ->
    Machine0 = z80_emulator:init(),
    Mem0 = Machine0#machine_state.memory,
    Mem1 = z80_mem:write_byte(Mem0, 0, 16#C8),  %% RET Z
    Mem2 = z80_mem:write_byte(Mem1, 16#1000, 16#00),
    Mem3 = z80_mem:write_byte(Mem2, 16#1001, 16#80),
    Cpu0 = Machine0#machine_state.cpu#cpu_state{sp = 16#1000, f = 16#40},
    Machine1 = Machine0#machine_state{memory = Mem3, cpu = Cpu0},
...
ret_nc_taken_test() ->
    Machine0 = z80_emulator:init(),
    Mem0 = Machine0#machine_state.memory,
    Mem1 = z80_mem:write_byte(Mem0, 0, 16#D0),  %% RET NC
    Mem2 = z80_mem:write_byte(Mem1, 16#1000, 16#00),
    Mem3 = z80_mem:write_byte(Mem2, 16#1001, 16#80),
    Cpu0 = Machine0#machine_state.cpu#cpu_state{sp = 16#1000, f = 0},
    Machine1 = Machine0#machine_state{memory = Mem3, cpu = Cpu0},
...
ret_c_taken_test() ->
    Machine0 = z80_emulator:init(),
    Mem0 = Machine0#machine_state.memory,
    Mem1 = z80_mem:write_byte(Mem0, 0, 16#D8),  %% RET C
    Mem2 = z80_mem:write_byte(Mem1, 16#1000, 16#00),
    Mem3 = z80_mem:write_byte(Mem2, 16#1001, 16#80),
...
ret_po_taken_test() ->
    Machine0 = z80_emulator:init(),
    Mem0 = Machine0#machine_state.memory,
    Mem1 = z80_mem:write_byte(Mem0, 0, 16#E0),  %% RET PO
    Mem2 = z80_mem:write_byte(Mem1, 16#1000, 16#00),
    Mem3 = z80_mem:write_byte(Mem2, 16#1001, 16#80),
    Cpu0 = Machine0#machine_state.cpu#cpu_state{sp = 16#1000, f = 0},
    Machine1 = Machine0#machine_state{memory = Mem3, cpu = Cpu0},
...
ret_pe_taken_test() ->
    Machine0 = z80_emulator:init(),
    Mem0 = Machine0#machine_state.memory,
    Mem1 = z80_mem:write_byte(Mem0, 0, 16#E8),  %% RET PE
    Mem2 = z80_mem:write_byte(Mem1, 16#1000, 16#00),
    Mem3 = z80_mem:write_byte(Mem2, 16#1001, 16#80),
...
ret_p_taken_test() ->
    Machine0 = z80_emulator:init(),
    Mem0 = Machine0#machine_state.memory,
    Mem1 = z80_mem:write_byte(Mem0, 0, 16#F0),  %% RET P
    Mem2 = z80_mem:write_byte(Mem1, 16#1000, 16#00),
    Mem3 = z80_mem:write_byte(Mem2, 16#1001, 16#80),
    Cpu0 = Machine0#machine_state.cpu#cpu_state{sp = 16#1000, f = 0},
    Machine1 = Machine0#machine_state{memory = Mem3, cpu = Cpu0},
...
ret_m_taken_test() ->
    Machine0 = z80_emulator:init(),
    Mem0 = Machine0#machine_state.memory,
    Mem1 = z80_mem:write_byte(Mem0, 0, 16#F8),  %% RET M
    Mem2 = z80_mem:write_byte(Mem1, 16#1000, 16#00),
    Mem3 = z80_mem:write_byte(Mem2, 16#1001, 16#80),
...
rst_00_test() ->
    ...
    Cpu0 = Machine0#machine_state.cpu#cpu_state{sp = 16#1000},
    Mem0 = Machine0#machine_state.memory,
    Mem1 = z80_mem:write_byte(Mem0, 0, 16#C7),  %% RST 00h
    ...
    ?assertEqual(16#01, z80_emulator:read_byte(Machine2, 16#0FFE)),  %% Low byte of pushed PC=1
    ?assertEqual(16#00, z80_emulator:read_byte(Machine2, 16#0FFF)).  %% High byte of pushed PC=1

rst_08_test() ->
    Machine0 = z80_emulator:init(),
    Cpu0 = Machine0#machine_state.cpu#cpu_state{sp = 16#1000},
    Mem0 = Machine0#machine_state.memory,
    Mem1 = z80_mem:write_byte(Mem0, 0, 16#CF),  %% RST 08h
    Machine1 = Machine0#machine_state{cpu = Cpu0, memory = Mem1},
    Machine2 = z80_cpu:step(Machine1),
...
rst_10_test() ->
    ...
    Cpu0 = Machine0#machine_state.cpu#cpu_state{sp = 16#1000},
    Mem0 = Machine0#machine_state.memory,
    Mem1 = z80_mem:write_byte(Mem0, 0, 16#D7),  %% RST 10h
    Machine1 = Machine0#machine_state{cpu = Cpu0, memory = Mem1},
    Machine2 = z80_cpu:step(Machine1),
...
rst_18_test() ->
    ...
    Cpu0 = Machine0#machine_state.cpu#cpu_state{sp = 16#1000},
    Mem0 = Machine0#machine_state.memory,
    Mem1 = z80_mem:write_byte(Mem0, 0, 16#DF),  %% RST 18h
    Machine1 = Machine0#machine_state{cpu = Cpu0, memory = Mem1},
    Machine2 = z80_cpu:step(Machine1),
...
rst_20_test() ->
    ...
    Cpu0 = Machine0#machine_state.cpu#cpu_state{sp = 16#1000},
    Mem0 = Machine0#machine_state.memory,
    Mem1 = z80_mem:write_byte(Mem0, 0, 16#E7),  %% RST 20h
    Machine1 = Machine0#machine_state{cpu = Cpu0, memory = Mem1},
    Machine2 = z80_cpu:step(Machine1),
...
rst_28_test() ->
    ...
    Cpu0 = Machine0#machine_state.cpu#cpu_state{sp = 16#1000},
    Mem0 = Machine0#machine_state.memory,
    Mem1 = z80_mem:write_byte(Mem0, 0, 16#EF),  %% RST 28h
    Machine1 = Machine0#machine_state{cpu = Cpu0, memory = Mem1},
    Machine2 = z80_cpu:step(Machine1),
...
rst_30_test() ->
    ...
    Cpu0 = Machine0#machine_state.cpu#cpu_state{sp = 16#1000},
    Mem0 = Machine0#machine_state.memory,
    Mem1 = z80_mem:write_byte(Mem0, 0, 16#F7),  %% RST 30h
    Machine1 = Machine0#machine_state{cpu = Cpu0, memory = Mem1},
    Machine2 = z80_cpu:step(Machine1),
...
rst_38_test() ->
    ...
    Cpu0 = Machine0#machine_state.cpu#cpu_state{sp = 16#1000},
    Mem0 = Machine0#machine_state.memory,
    Mem1 = z80_mem:write_byte(Mem0, 0, 16#FF),  %% RST 38h
    Machine1 = Machine0#machine_state{cpu = Cpu0, memory = Mem1},
    Machine2 = z80_cpu:step(Machine1),
