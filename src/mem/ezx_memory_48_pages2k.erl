-module(ezx_memory_48_pages2k).

%% @doc ZX Spectrum 48K memory backend using a tuple of 2KB pages.
%%
...
write_byte(State, Addr, Byte) ->
    ...
    case Index < 16#4000 of
        ...
        false ->
            ...
            <<Prefix:Offset/binary, Old:8, Suffix/binary>> = Bin,
            case Old =:= Byte of
                true ->
                    State;
                false ->
                    NewBin = <<Prefix/binary, Byte:8, Suffix/binary>>,
