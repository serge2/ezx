-module(ezx_memory_48_pages1k).

%% @doc ZX Spectrum 48K memory backend using a tuple of 1KB pages.
%%
%% 64 pages of 1024 bytes each. Faster than 4KB pages for CPU work
%% due to tighter page offsets, but bulk reads incur more page crossings.
