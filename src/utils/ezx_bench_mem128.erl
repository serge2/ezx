...
bench_one(MemMod, Rom0, Rom1, DurationSec) ->
    M0 = ezx_emulator_128:init(z80_cpu, MemMod, ezx_screen, ezx_keyboard, ezx_beeper2, {Rom0, Rom1}),
    ...
    M2 = ezx_emulator_128:init(z80_cpu, MemMod, ezx_screen, ezx_keyboard, ezx_beeper2, {Rom0, Rom1}),
    M3 = warmup(M2, 100),
